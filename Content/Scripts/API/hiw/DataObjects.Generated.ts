module hiw {
    ...
    export class Age extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Age>>, page?: number) {
            api.executeEndpoint<Array<Age>>(Endpoint.fromSelf<Array<Age>>(), callback, null, null, page);
        }

        /** Gets how many Ages exist. */
        public static getAllCount(api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback);
        }

        /** Gets how many pages of data exist for the Ages method. */
        public static getAllPageCount(api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Age>) {
            api.executeEndpoint<Age>(Endpoint.fromSelf<Age>(), callback, { id: id });
        }

        /** Returns a filtered collection of Ages based on the provided filter.
         *  @param filter The Filter to apply.
         *  @return All Ages which match the provided filter. */
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Age>>, page?: number) {
            api.executeEndpoint<Array<Age>>(Endpoint.fromSelf<Array<Age>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static filterCount(filter: Filter, api: API, callback: IAPICallback<number>) {
        ...
        public static filterPageCount(filter: Filter, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, null, filter.toJSON());
        }

        /** Gets Ages by ParentAgeID.
         *  @return An Array of Ages. */
        public getAges(api: API, callback: IAPICallback<Array<Age>>, page?: number) {
         ...
         *  @return An Array of Ages. */
        public static getByParentAgeID(ageID: number, api: API, callback: IAPICallback<Array<Age>>, page?: number) {
            api.executeEndpoint<Array<Age>>(Endpoint.fromSelf<Array<Age>>(), callback, { ageID: ageID }, null, page);
        }

        /** Gets how many Ages by ParentAgeID exist. 
         *  @return An Array of Ages. */
        public getAgesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param ageID The ID of the Age for which to retrieve the child Ages.
         *  @return An Array of Ages. */
        public static getByParentAgeIDCount(ageID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { ageID: ageID });
        }

        /** Gets how many pages of Ages by ParentAgeID exist.
         *  @return An Array of Ages. */
        public getAgesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param ageID The ID of the Age for which to retrieve the child Ages.
         *  @return An Array of Ages. */
        public static getByParentAgeIDPageCount(ageID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { ageID: ageID });
        }

        /** Returns the related ParentAge based on the unique ID of the related Age.
         *  @return A single Age, or null. */
        public getParentAge(api: API, callback: IAPICallback<Age>) {
         ...
         *  @return A single Age, or null. */
        public static getParentAgeForAge(ageID: number, api: API, callback: IAPICallback<Age>) {
    ...
    export class AgeRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<AgeRelation>>, page?: number) {
            api.executeEndpoint<Array<AgeRelation>>(Endpoint.fromSelf<Array<AgeRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<AgeRelation>) {
            api.executeEndpoint<AgeRelation>(Endpoint.fromSelf<AgeRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<AgeRelation>>, page?: number) {
            api.executeEndpoint<Array<AgeRelation>>(Endpoint.fromSelf<Array<AgeRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorAgeID(ageID: number, api: API, callback: IAPICallback<Array<AgeRelation>>, page?: number) {
            api.executeEndpoint<Array<AgeRelation>>(Endpoint.fromSelf<Array<AgeRelation>>(), callback, { ageID: ageID }, null, page);
        }

        /** Gets how many AgeRelations by AncestorAgeID exist. 
         *  @param ageID The ID of the Age for which to retrieve the child AgeRelations.
         *  @return An Array of AgeRelations. */
        public static getByAncestorAgeIDCount(ageID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { ageID: ageID });
        }
         ...
         *  @param ageID The ID of the Age for which to retrieve the child AgeRelations.
         *  @return An Array of AgeRelations. */
        public static getByAncestorAgeIDPageCount(ageID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { ageID: ageID });
        }
         ...
         *  @param ageID The ID of the Age for which to retrieve the child AgeRelations.
         *  @return An Array of AgeRelations. */
        public static getByDescendantAgeID(ageID: number, api: API, callback: IAPICallback<Array<AgeRelation>>, page?: number) {
            api.executeEndpoint<Array<AgeRelation>>(Endpoint.fromSelf<Array<AgeRelation>>(), callback, { ageID: ageID }, null, page);
        }
         ...
         *  @param ageID The ID of the Age for which to retrieve the child AgeRelations.
         *  @return An Array of AgeRelations. */
        public static getByDescendantAgeIDCount(ageID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { ageID: ageID });
        }
         ...
         *  @param ageID The ID of the Age for which to retrieve the child AgeRelations.
         *  @return An Array of AgeRelations. */
        public static getByDescendantAgeIDPageCount(ageID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { ageID: ageID });
        }
    ...
    export class CharacteristicOfSchoolOrStudent extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<CharacteristicOfSchoolOrStudent>>, page?: number) {
            api.executeEndpoint<Array<CharacteristicOfSchoolOrStudent>>(Endpoint.fromSelf<Array<CharacteristicOfSchoolOrStudent>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<CharacteristicOfSchoolOrStudent>) {
            api.executeEndpoint<CharacteristicOfSchoolOrStudent>(Endpoint.fromSelf<CharacteristicOfSchoolOrStudent>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<CharacteristicOfSchoolOrStudent>>, page?: number) {
            api.executeEndpoint<Array<CharacteristicOfSchoolOrStudent>>(Endpoint.fromSelf<Array<CharacteristicOfSchoolOrStudent>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getCharacteristicOfSchoolOrStudents(api: API, callback: IAPICallback<Array<CharacteristicOfSchoolOrStudent>>, page?: number) {
         ...
         *  @return An Array of CharacteristicOfSchoolOrStudents. */
        public static getByParentCharacteristicOfSchoolOrStudentID(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<Array<CharacteristicOfSchoolOrStudent>>, page?: number) {
            api.executeEndpoint<Array<CharacteristicOfSchoolOrStudent>>(Endpoint.fromSelf<Array<CharacteristicOfSchoolOrStudent>>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID }, null, page);
        }

        /** Gets how many CharacteristicOfSchoolOrStudents by ParentCharacteristicOfSchoolOrStudentID exist. 
         *  @return An Array of CharacteristicOfSchoolOrStudents. */
        public getCharacteristicOfSchoolOrStudentsCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child CharacteristicOfSchoolOrStudents.
         *  @return An Array of CharacteristicOfSchoolOrStudents. */
        public static getByParentCharacteristicOfSchoolOrStudentIDCount(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID });
        }

        /** Gets how many pages of CharacteristicOfSchoolOrStudents by ParentCharacteristicOfSchoolOrStudentID exist.
         *  @return An Array of CharacteristicOfSchoolOrStudents. */
        public getCharacteristicOfSchoolOrStudentsPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child CharacteristicOfSchoolOrStudents.
         *  @return An Array of CharacteristicOfSchoolOrStudents. */
        public static getByParentCharacteristicOfSchoolOrStudentIDPageCount(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID });
        }
        ...
        public getParentCharacteristicOfSchoolOrStudent(api: API, callback: IAPICallback<CharacteristicOfSchoolOrStudent>) {
         ...
         *  @return A single CharacteristicOfSchoolOrStudent, or null. */
        public static getParentCharacteristicOfSchoolOrStudentForCharacteristicOfSchoolOrStudent(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<CharacteristicOfSchoolOrStudent>) {
    ...
    export class CharacteristicOfSchoolOrStudentRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<CharacteristicOfSchoolOrStudentRelation>>, page?: number) {
            api.executeEndpoint<Array<CharacteristicOfSchoolOrStudentRelation>>(Endpoint.fromSelf<Array<CharacteristicOfSchoolOrStudentRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<CharacteristicOfSchoolOrStudentRelation>) {
            api.executeEndpoint<CharacteristicOfSchoolOrStudentRelation>(Endpoint.fromSelf<CharacteristicOfSchoolOrStudentRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<CharacteristicOfSchoolOrStudentRelation>>, page?: number) {
            api.executeEndpoint<Array<CharacteristicOfSchoolOrStudentRelation>>(Endpoint.fromSelf<Array<CharacteristicOfSchoolOrStudentRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorCharacteristicOfSchoolOrStudentID(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<Array<CharacteristicOfSchoolOrStudentRelation>>, page?: number) {
            api.executeEndpoint<Array<CharacteristicOfSchoolOrStudentRelation>>(Endpoint.fromSelf<Array<CharacteristicOfSchoolOrStudentRelation>>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID }, null, page);
        }

        /** Gets how many CharacteristicOfSchoolOrStudentRelations by AncestorCharacteristicOfSchoolOrStudentID exist. 
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child CharacteristicOfSchoolOrStudentRelations.
         *  @return An Array of CharacteristicOfSchoolOrStudentRelations. */
        public static getByAncestorCharacteristicOfSchoolOrStudentIDCount(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID });
        }
         ...
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child CharacteristicOfSchoolOrStudentRelations.
         *  @return An Array of CharacteristicOfSchoolOrStudentRelations. */
        public static getByAncestorCharacteristicOfSchoolOrStudentIDPageCount(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID });
        }
         ...
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child CharacteristicOfSchoolOrStudentRelations.
         *  @return An Array of CharacteristicOfSchoolOrStudentRelations. */
        public static getByDescendantCharacteristicOfSchoolOrStudentID(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<Array<CharacteristicOfSchoolOrStudentRelation>>, page?: number) {
            api.executeEndpoint<Array<CharacteristicOfSchoolOrStudentRelation>>(Endpoint.fromSelf<Array<CharacteristicOfSchoolOrStudentRelation>>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID }, null, page);
        }
         ...
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child CharacteristicOfSchoolOrStudentRelations.
         *  @return An Array of CharacteristicOfSchoolOrStudentRelations. */
        public static getByDescendantCharacteristicOfSchoolOrStudentIDCount(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID });
        }
         ...
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child CharacteristicOfSchoolOrStudentRelations.
         *  @return An Array of CharacteristicOfSchoolOrStudentRelations. */
        public static getByDescendantCharacteristicOfSchoolOrStudentIDPageCount(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID });
        }
    ...
    export class CountryOfBirth extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<CountryOfBirth>>, page?: number) {
            api.executeEndpoint<Array<CountryOfBirth>>(Endpoint.fromSelf<Array<CountryOfBirth>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<CountryOfBirth>) {
            api.executeEndpoint<CountryOfBirth>(Endpoint.fromSelf<CountryOfBirth>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<CountryOfBirth>>, page?: number) {
            api.executeEndpoint<Array<CountryOfBirth>>(Endpoint.fromSelf<Array<CountryOfBirth>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getCountryOfBirths(api: API, callback: IAPICallback<Array<CountryOfBirth>>, page?: number) {
         ...
         *  @return An Array of CountryOfBirths. */
        public static getByParentCountryOfBirthID(countryOfBirthID: number, api: API, callback: IAPICallback<Array<CountryOfBirth>>, page?: number) {
            api.executeEndpoint<Array<CountryOfBirth>>(Endpoint.fromSelf<Array<CountryOfBirth>>(), callback, { countryOfBirthID: countryOfBirthID }, null, page);
        }

        /** Gets how many CountryOfBirths by ParentCountryOfBirthID exist. 
         *  @return An Array of CountryOfBirths. */
        public getCountryOfBirthsCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child CountryOfBirths.
         *  @return An Array of CountryOfBirths. */
        public static getByParentCountryOfBirthIDCount(countryOfBirthID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { countryOfBirthID: countryOfBirthID });
        }

        /** Gets how many pages of CountryOfBirths by ParentCountryOfBirthID exist.
         *  @return An Array of CountryOfBirths. */
        public getCountryOfBirthsPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child CountryOfBirths.
         *  @return An Array of CountryOfBirths. */
        public static getByParentCountryOfBirthIDPageCount(countryOfBirthID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { countryOfBirthID: countryOfBirthID });
        }
        ...
        public getParentCountryOfBirth(api: API, callback: IAPICallback<CountryOfBirth>) {
         ...
         *  @return A single CountryOfBirth, or null. */
        public static getParentCountryOfBirthForCountryOfBirth(countryOfBirthID: number, api: API, callback: IAPICallback<CountryOfBirth>) {
    ...
    export class CountryOfBirthRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<CountryOfBirthRelation>>, page?: number) {
            api.executeEndpoint<Array<CountryOfBirthRelation>>(Endpoint.fromSelf<Array<CountryOfBirthRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<CountryOfBirthRelation>) {
            api.executeEndpoint<CountryOfBirthRelation>(Endpoint.fromSelf<CountryOfBirthRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<CountryOfBirthRelation>>, page?: number) {
            api.executeEndpoint<Array<CountryOfBirthRelation>>(Endpoint.fromSelf<Array<CountryOfBirthRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorCountryOfBirthID(countryOfBirthID: number, api: API, callback: IAPICallback<Array<CountryOfBirthRelation>>, page?: number) {
            api.executeEndpoint<Array<CountryOfBirthRelation>>(Endpoint.fromSelf<Array<CountryOfBirthRelation>>(), callback, { countryOfBirthID: countryOfBirthID }, null, page);
        }

        /** Gets how many CountryOfBirthRelations by AncestorCountryOfBirthID exist. 
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child CountryOfBirthRelations.
         *  @return An Array of CountryOfBirthRelations. */
        public static getByAncestorCountryOfBirthIDCount(countryOfBirthID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { countryOfBirthID: countryOfBirthID });
        }
         ...
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child CountryOfBirthRelations.
         *  @return An Array of CountryOfBirthRelations. */
        public static getByAncestorCountryOfBirthIDPageCount(countryOfBirthID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { countryOfBirthID: countryOfBirthID });
        }
         ...
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child CountryOfBirthRelations.
         *  @return An Array of CountryOfBirthRelations. */
        public static getByDescendantCountryOfBirthID(countryOfBirthID: number, api: API, callback: IAPICallback<Array<CountryOfBirthRelation>>, page?: number) {
            api.executeEndpoint<Array<CountryOfBirthRelation>>(Endpoint.fromSelf<Array<CountryOfBirthRelation>>(), callback, { countryOfBirthID: countryOfBirthID }, null, page);
        }
         ...
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child CountryOfBirthRelations.
         *  @return An Array of CountryOfBirthRelations. */
        public static getByDescendantCountryOfBirthIDCount(countryOfBirthID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { countryOfBirthID: countryOfBirthID });
        }
         ...
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child CountryOfBirthRelations.
         *  @return An Array of CountryOfBirthRelations. */
        public static getByDescendantCountryOfBirthIDPageCount(countryOfBirthID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { countryOfBirthID: countryOfBirthID });
        }
    ...
    export class DataCategory extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DataCategory>>, page?: number) {
            api.executeEndpoint<Array<DataCategory>>(Endpoint.fromSelf<Array<DataCategory>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DataCategory>) {
            api.executeEndpoint<DataCategory>(Endpoint.fromSelf<DataCategory>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DataCategory>>, page?: number) {
            api.executeEndpoint<Array<DataCategory>>(Endpoint.fromSelf<Array<DataCategory>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getParentDataCategories(api: API, callback: IAPICallback<Array<DataCategory>>, page?: number) {
         ...
         *  @return An Array of DataCategories. */
        public static getByParentDataCategoryID(dataCategoryID: number, api: API, callback: IAPICallback<Array<DataCategory>>, page?: number) {
            api.executeEndpoint<Array<DataCategory>>(Endpoint.fromSelf<Array<DataCategory>>(), callback, { dataCategoryID: dataCategoryID }, null, page);
        }

        /** Gets how many DataCategories by ParentDataCategoryID exist. 
         *  @return An Array of DataCategories. */
        public getParentDataCategoriesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child DataCategories.
         *  @return An Array of DataCategories. */
        public static getByParentDataCategoryIDCount(dataCategoryID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataCategoryID: dataCategoryID });
        }

        /** Gets how many pages of DataCategories by ParentDataCategoryID exist.
         *  @return An Array of DataCategories. */
        public getParentDataCategoriesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child DataCategories.
         *  @return An Array of DataCategories. */
        public static getByParentDataCategoryIDPageCount(dataCategoryID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataCategoryID: dataCategoryID });
        }
        ...
        public getParentDataCategory(api: API, callback: IAPICallback<DataCategory>) {
         ...
         *  @return A single DataCategory, or null. */
        public static getParentDataCategoryForDataCategory(dataCategoryID: number, api: API, callback: IAPICallback<DataCategory>) {
         ...
         *  @return An Array of DataCategories. */
        public static getByInitiativeID(initiativeID: number, api: API, callback: IAPICallback<Array<DataCategory>>, page?: number) {
            api.executeEndpoint<Array<DataCategory>>(Endpoint.fromSelf<Array<DataCategory>>(), callback, { initiativeID: initiativeID }, null, page);
        }

        /** Gets how many DataCategories by InitiativeID exist. 
         *  @param initiativeID The ID of the Initiative for which to retrieve the child DataCategories.
         *  @return An Array of DataCategories. */
        public static getByInitiativeIDCount(initiativeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { initiativeID: initiativeID });
        }

        /** Gets how many pages of DataCategories by InitiativeID exist.
         *  @param initiativeID The ID of the Initiative for which to retrieve the child DataCategories.
         *  @return An Array of DataCategories. */
        public static getByInitiativeIDPageCount(initiativeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { initiativeID: initiativeID });
        }
    ...
    export class DataCategoryRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DataCategoryRelation>>, page?: number) {
            api.executeEndpoint<Array<DataCategoryRelation>>(Endpoint.fromSelf<Array<DataCategoryRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DataCategoryRelation>) {
            api.executeEndpoint<DataCategoryRelation>(Endpoint.fromSelf<DataCategoryRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DataCategoryRelation>>, page?: number) {
            api.executeEndpoint<Array<DataCategoryRelation>>(Endpoint.fromSelf<Array<DataCategoryRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorDataCategoryID(dataCategoryID: number, api: API, callback: IAPICallback<Array<DataCategoryRelation>>, page?: number) {
            api.executeEndpoint<Array<DataCategoryRelation>>(Endpoint.fromSelf<Array<DataCategoryRelation>>(), callback, { dataCategoryID: dataCategoryID }, null, page);
        }

        /** Gets how many DataCategoryRelations by AncestorDataCategoryID exist. 
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child DataCategoryRelations.
         *  @return An Array of DataCategoryRelations. */
        public static getByAncestorDataCategoryIDCount(dataCategoryID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataCategoryID: dataCategoryID });
        }
         ...
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child DataCategoryRelations.
         *  @return An Array of DataCategoryRelations. */
        public static getByAncestorDataCategoryIDPageCount(dataCategoryID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataCategoryID: dataCategoryID });
        }
         ...
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child DataCategoryRelations.
         *  @return An Array of DataCategoryRelations. */
        public static getByDescendantDataCategoryID(dataCategoryID: number, api: API, callback: IAPICallback<Array<DataCategoryRelation>>, page?: number) {
            api.executeEndpoint<Array<DataCategoryRelation>>(Endpoint.fromSelf<Array<DataCategoryRelation>>(), callback, { dataCategoryID: dataCategoryID }, null, page);
        }
         ...
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child DataCategoryRelations.
         *  @return An Array of DataCategoryRelations. */
        public static getByDescendantDataCategoryIDCount(dataCategoryID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataCategoryID: dataCategoryID });
        }
         ...
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child DataCategoryRelations.
         *  @return An Array of DataCategoryRelations. */
        public static getByDescendantDataCategoryIDPageCount(dataCategoryID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataCategoryID: dataCategoryID });
        }
    ...
    export class DataSourceDataSupplier extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DataSourceDataSupplier>>, page?: number) {
            api.executeEndpoint<Array<DataSourceDataSupplier>>(Endpoint.fromSelf<Array<DataSourceDataSupplier>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DataSourceDataSupplier>) {
            api.executeEndpoint<DataSourceDataSupplier>(Endpoint.fromSelf<DataSourceDataSupplier>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DataSourceDataSupplier>>, page?: number) {
            api.executeEndpoint<Array<DataSourceDataSupplier>>(Endpoint.fromSelf<Array<DataSourceDataSupplier>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByDataSourceID(dataSourceID: number, api: API, callback: IAPICallback<Array<DataSourceDataSupplier>>, page?: number) {
            api.executeEndpoint<Array<DataSourceDataSupplier>>(Endpoint.fromSelf<Array<DataSourceDataSupplier>>(), callback, { dataSourceID: dataSourceID }, null, page);
        }

        /** Gets how many DataSourceDataSuppliers by DataSourceID exist. 
         *  @param dataSourceID The ID of the DataSource for which to retrieve the child DataSourceDataSuppliers.
         *  @return An Array of DataSourceDataSuppliers. */
        public static getByDataSourceIDCount(dataSourceID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataSourceID: dataSourceID });
        }

        /** Gets how many pages of DataSourceDataSuppliers by DataSourceID exist.
         *  @param dataSourceID The ID of the DataSource for which to retrieve the child DataSourceDataSuppliers.
         *  @return An Array of DataSourceDataSuppliers. */
        public static getByDataSourceIDPageCount(dataSourceID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataSourceID: dataSourceID });
        }
         ...
         *  @return An Array of DataSourceDataSuppliers. */
        public static getByDataSupplierID(dataSupplierID: number, api: API, callback: IAPICallback<Array<DataSourceDataSupplier>>, page?: number) {
            api.executeEndpoint<Array<DataSourceDataSupplier>>(Endpoint.fromSelf<Array<DataSourceDataSupplier>>(), callback, { dataSupplierID: dataSupplierID }, null, page);
        }

        /** Gets how many DataSourceDataSuppliers by DataSupplierID exist. 
         *  @param dataSupplierID The ID of the DataSupplier for which to retrieve the child DataSourceDataSuppliers.
         *  @return An Array of DataSourceDataSuppliers. */
        public static getByDataSupplierIDCount(dataSupplierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataSupplierID: dataSupplierID });
        }

        /** Gets how many pages of DataSourceDataSuppliers by DataSupplierID exist.
         *  @param dataSupplierID The ID of the DataSupplier for which to retrieve the child DataSourceDataSuppliers.
         *  @return An Array of DataSourceDataSuppliers. */
        public static getByDataSupplierIDPageCount(dataSupplierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataSupplierID: dataSupplierID });
        }
    ...
    export class DataSource extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DataSource>>, page?: number) {
            api.executeEndpoint<Array<DataSource>>(Endpoint.fromSelf<Array<DataSource>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DataSource>) {
            api.executeEndpoint<DataSource>(Endpoint.fromSelf<DataSource>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DataSource>>, page?: number) {
            api.executeEndpoint<Array<DataSource>>(Endpoint.fromSelf<Array<DataSource>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class DataSourceURL extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DataSourceURL>>, page?: number) {
            api.executeEndpoint<Array<DataSourceURL>>(Endpoint.fromSelf<Array<DataSourceURL>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DataSourceURL>) {
            api.executeEndpoint<DataSourceURL>(Endpoint.fromSelf<DataSourceURL>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DataSourceURL>>, page?: number) {
            api.executeEndpoint<Array<DataSourceURL>>(Endpoint.fromSelf<Array<DataSourceURL>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByDataSourceID(dataSourceID: number, api: API, callback: IAPICallback<Array<DataSourceURL>>, page?: number) {
            api.executeEndpoint<Array<DataSourceURL>>(Endpoint.fromSelf<Array<DataSourceURL>>(), callback, { dataSourceID: dataSourceID }, null, page);
        }
         ...
         *  @return An Array of DataSourceURLs. */
        public static getByUrlID(urlID: number, api: API, callback: IAPICallback<Array<DataSourceURL>>, page?: number) {
            api.executeEndpoint<Array<DataSourceURL>>(Endpoint.fromSelf<Array<DataSourceURL>>(), callback, { urlID: urlID }, null, page);
        }

        /** Gets how many DataSourceURLs by UrlID exist. 
         *  @param urlID The ID of the Url for which to retrieve the child DataSourceURLs.
         *  @return An Array of DataSourceURLs. */
        public static getByUrlIDCount(urlID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { urlID: urlID });
        }

        /** Gets how many pages of DataSourceURLs by UrlID exist.
         *  @param urlID The ID of the Url for which to retrieve the child DataSourceURLs.
         *  @return An Array of DataSourceURLs. */
        public static getByUrlIDPageCount(urlID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { urlID: urlID });
        }
    ...
    export class DataSupplier extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DataSupplier>>, page?: number) {
            api.executeEndpoint<Array<DataSupplier>>(Endpoint.fromSelf<Array<DataSupplier>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DataSupplier>) {
            api.executeEndpoint<DataSupplier>(Endpoint.fromSelf<DataSupplier>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DataSupplier>>, page?: number) {
            api.executeEndpoint<Array<DataSupplier>>(Endpoint.fromSelf<Array<DataSupplier>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByUrlID(urlID: number, api: API, callback: IAPICallback<Array<DataSupplier>>, page?: number) {
            api.executeEndpoint<Array<DataSupplier>>(Endpoint.fromSelf<Array<DataSupplier>>(), callback, { urlID: urlID }, null, page);
        }
    ...
    export class DimensionBook extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DimensionBook>>, page?: number) {
            api.executeEndpoint<Array<DimensionBook>>(Endpoint.fromSelf<Array<DimensionBook>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DimensionBook>) {
            api.executeEndpoint<DimensionBook>(Endpoint.fromSelf<DimensionBook>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DimensionBook>>, page?: number) {
            api.executeEndpoint<Array<DimensionBook>>(Endpoint.fromSelf<Array<DimensionBook>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getDimensionBooks(api: API, callback: IAPICallback<Array<DimensionBook>>, page?: number) {
         ...
         *  @return An Array of DimensionBooks. */
        public static getByParentDimensionBookID(dimensionBookID: number, api: API, callback: IAPICallback<Array<DimensionBook>>, page?: number) {
            api.executeEndpoint<Array<DimensionBook>>(Endpoint.fromSelf<Array<DimensionBook>>(), callback, { dimensionBookID: dimensionBookID }, null, page);
        }

        /** Gets how many DimensionBooks by ParentDimensionBookID exist. 
         *  @return An Array of DimensionBooks. */
        public getDimensionBooksCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child DimensionBooks.
         *  @return An Array of DimensionBooks. */
        public static getByParentDimensionBookIDCount(dimensionBookID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionBookID: dimensionBookID });
        }

        /** Gets how many pages of DimensionBooks by ParentDimensionBookID exist.
         *  @return An Array of DimensionBooks. */
        public getDimensionBooksPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child DimensionBooks.
         *  @return An Array of DimensionBooks. */
        public static getByParentDimensionBookIDPageCount(dimensionBookID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionBookID: dimensionBookID });
        }
        ...
        public getParentDimensionBook(api: API, callback: IAPICallback<DimensionBook>) {
         ...
         *  @return A single DimensionBook, or null. */
        public static getParentDimensionBookForDimensionBook(dimensionBookID: number, api: API, callback: IAPICallback<DimensionBook>) {
         ...
         *  @return An Array of DimensionBooks. */
        public static getByDimensionListID(dimensionListID: number, api: API, callback: IAPICallback<Array<DimensionBook>>, page?: number) {
            api.executeEndpoint<Array<DimensionBook>>(Endpoint.fromSelf<Array<DimensionBook>>(), callback, { dimensionListID: dimensionListID }, null, page);
        }

        /** Gets how many DimensionBooks by DimensionListID exist. 
         *  @param dimensionListID The ID of the DimensionList for which to retrieve the child DimensionBooks.
         *  @return An Array of DimensionBooks. */
        public static getByDimensionListIDCount(dimensionListID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionListID: dimensionListID });
        }

        /** Gets how many pages of DimensionBooks by DimensionListID exist.
         *  @param dimensionListID The ID of the DimensionList for which to retrieve the child DimensionBooks.
         *  @return An Array of DimensionBooks. */
        public static getByDimensionListIDPageCount(dimensionListID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionListID: dimensionListID });
        }
         ...
         *  @return A single DimensionBook, or null. */
        public static getByKey(key: string, api: API, callback: IAPICallback<DimensionBook>) {
    ...
    export class DimensionBookRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DimensionBookRelation>>, page?: number) {
            api.executeEndpoint<Array<DimensionBookRelation>>(Endpoint.fromSelf<Array<DimensionBookRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DimensionBookRelation>) {
            api.executeEndpoint<DimensionBookRelation>(Endpoint.fromSelf<DimensionBookRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DimensionBookRelation>>, page?: number) {
            api.executeEndpoint<Array<DimensionBookRelation>>(Endpoint.fromSelf<Array<DimensionBookRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorDimensionBookID(dimensionBookID: number, api: API, callback: IAPICallback<Array<DimensionBookRelation>>, page?: number) {
            api.executeEndpoint<Array<DimensionBookRelation>>(Endpoint.fromSelf<Array<DimensionBookRelation>>(), callback, { dimensionBookID: dimensionBookID }, null, page);
        }

        /** Gets how many DimensionBookRelations by AncestorDimensionBookID exist. 
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child DimensionBookRelations.
         *  @return An Array of DimensionBookRelations. */
        public static getByAncestorDimensionBookIDCount(dimensionBookID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionBookID: dimensionBookID });
        }
         ...
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child DimensionBookRelations.
         *  @return An Array of DimensionBookRelations. */
        public static getByAncestorDimensionBookIDPageCount(dimensionBookID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionBookID: dimensionBookID });
        }
         ...
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child DimensionBookRelations.
         *  @return An Array of DimensionBookRelations. */
        public static getByDescendantDimensionBookID(dimensionBookID: number, api: API, callback: IAPICallback<Array<DimensionBookRelation>>, page?: number) {
            api.executeEndpoint<Array<DimensionBookRelation>>(Endpoint.fromSelf<Array<DimensionBookRelation>>(), callback, { dimensionBookID: dimensionBookID }, null, page);
        }
         ...
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child DimensionBookRelations.
         *  @return An Array of DimensionBookRelations. */
        public static getByDescendantDimensionBookIDCount(dimensionBookID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionBookID: dimensionBookID });
        }
         ...
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child DimensionBookRelations.
         *  @return An Array of DimensionBookRelations. */
        public static getByDescendantDimensionBookIDPageCount(dimensionBookID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionBookID: dimensionBookID });
        }
    ...
    export class DimensionGraph extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DimensionGraph>) {
            api.executeEndpoint<DimensionGraph>(Endpoint.fromSelf<DimensionGraph>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByTotalID(totalID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { totalID: totalID }, null, page);
        }

        /** Gets how many DimensionGraphs by TotalID exist. 
         *  @param totalID The ID of the Total for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByTotalIDCount(totalID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { totalID: totalID });
        }

        /** Gets how many pages of DimensionGraphs by TotalID exist.
         *  @param totalID The ID of the Total for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByTotalIDPageCount(totalID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { totalID: totalID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByAgeID(ageID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { ageID: ageID }, null, page);
        }

        /** Gets how many DimensionGraphs by AgeID exist. 
         *  @param ageID The ID of the Age for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByAgeIDCount(ageID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { ageID: ageID });
        }
         ...
         *  @param ageID The ID of the Age for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByAgeIDPageCount(ageID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { ageID: ageID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getBySexID(sexID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { sexID: sexID }, null, page);
        }

        /** Gets how many DimensionGraphs by SexID exist. 
         *  @param sexID The ID of the Sex for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getBySexIDCount(sexID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexID: sexID });
        }

        /** Gets how many pages of DimensionGraphs by SexID exist.
         *  @param sexID The ID of the Sex for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getBySexIDPageCount(sexID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexID: sexID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByRaceEthnicityID(raceEthnicityID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { raceEthnicityID: raceEthnicityID }, null, page);
        }

        /** Gets how many DimensionGraphs by RaceEthnicityID exist. 
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByRaceEthnicityIDCount(raceEthnicityID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { raceEthnicityID: raceEthnicityID });
        }

        /** Gets how many pages of DimensionGraphs by RaceEthnicityID exist.
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByRaceEthnicityIDPageCount(raceEthnicityID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { raceEthnicityID: raceEthnicityID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByIncomeAndPovertyStatusID(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID }, null, page);
        }

        /** Gets how many DimensionGraphs by IncomeAndPovertyStatusID exist. 
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByIncomeAndPovertyStatusIDCount(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID });
        }

        /** Gets how many pages of DimensionGraphs by IncomeAndPovertyStatusID exist.
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByIncomeAndPovertyStatusIDPageCount(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByEducationalAttainmentID(educationalAttainmentID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { educationalAttainmentID: educationalAttainmentID }, null, page);
        }

        /** Gets how many DimensionGraphs by EducationalAttainmentID exist. 
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByEducationalAttainmentIDCount(educationalAttainmentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { educationalAttainmentID: educationalAttainmentID });
        }

        /** Gets how many pages of DimensionGraphs by EducationalAttainmentID exist.
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByEducationalAttainmentIDPageCount(educationalAttainmentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { educationalAttainmentID: educationalAttainmentID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByHealthInsuranceStatusID(healthInsuranceStatusID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID }, null, page);
        }

        /** Gets how many DimensionGraphs by HealthInsuranceStatusID exist. 
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByHealthInsuranceStatusIDCount(healthInsuranceStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID });
        }

        /** Gets how many pages of DimensionGraphs by HealthInsuranceStatusID exist.
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByHealthInsuranceStatusIDPageCount(healthInsuranceStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getBySexualOrientationID(sexualOrientationID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { sexualOrientationID: sexualOrientationID }, null, page);
        }

        /** Gets how many DimensionGraphs by SexualOrientationID exist. 
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getBySexualOrientationIDCount(sexualOrientationID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexualOrientationID: sexualOrientationID });
        }

        /** Gets how many pages of DimensionGraphs by SexualOrientationID exist.
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getBySexualOrientationIDPageCount(sexualOrientationID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexualOrientationID: sexualOrientationID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByFamilyTypeID(familyTypeID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { familyTypeID: familyTypeID }, null, page);
        }

        /** Gets how many DimensionGraphs by FamilyTypeID exist. 
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByFamilyTypeIDCount(familyTypeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { familyTypeID: familyTypeID });
        }

        /** Gets how many pages of DimensionGraphs by FamilyTypeID exist.
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByFamilyTypeIDPageCount(familyTypeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { familyTypeID: familyTypeID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByMaritalStatusID(maritalStatusID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { maritalStatusID: maritalStatusID }, null, page);
        }

        /** Gets how many DimensionGraphs by MaritalStatusID exist. 
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByMaritalStatusIDCount(maritalStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { maritalStatusID: maritalStatusID });
        }

        /** Gets how many pages of DimensionGraphs by MaritalStatusID exist.
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByMaritalStatusIDPageCount(maritalStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { maritalStatusID: maritalStatusID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByVeteranStatusID(veteranStatusID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { veteranStatusID: veteranStatusID }, null, page);
        }

        /** Gets how many DimensionGraphs by VeteranStatusID exist. 
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByVeteranStatusIDCount(veteranStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { veteranStatusID: veteranStatusID });
        }

        /** Gets how many pages of DimensionGraphs by VeteranStatusID exist.
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByVeteranStatusIDPageCount(veteranStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { veteranStatusID: veteranStatusID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByCountryOfBirthID(countryOfBirthID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { countryOfBirthID: countryOfBirthID }, null, page);
        }

        /** Gets how many DimensionGraphs by CountryOfBirthID exist. 
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByCountryOfBirthIDCount(countryOfBirthID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { countryOfBirthID: countryOfBirthID });
        }
         ...
         *  @param countryOfBirthID The ID of the CountryOfBirth for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByCountryOfBirthIDPageCount(countryOfBirthID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { countryOfBirthID: countryOfBirthID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByDisabilityStatusID(disabilityStatusID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { disabilityStatusID: disabilityStatusID }, null, page);
        }

        /** Gets how many DimensionGraphs by DisabilityStatusID exist. 
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByDisabilityStatusIDCount(disabilityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { disabilityStatusID: disabilityStatusID });
        }

        /** Gets how many pages of DimensionGraphs by DisabilityStatusID exist.
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByDisabilityStatusIDPageCount(disabilityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { disabilityStatusID: disabilityStatusID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByObesityStatusID(obesityStatusID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { obesityStatusID: obesityStatusID }, null, page);
        }

        /** Gets how many DimensionGraphs by ObesityStatusID exist. 
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByObesityStatusIDCount(obesityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { obesityStatusID: obesityStatusID });
        }

        /** Gets how many pages of DimensionGraphs by ObesityStatusID exist.
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByObesityStatusIDPageCount(obesityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { obesityStatusID: obesityStatusID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByCharacteristicOfSchoolOrStudentID(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID }, null, page);
        }

        /** Gets how many DimensionGraphs by CharacteristicOfSchoolOrStudentID exist. 
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByCharacteristicOfSchoolOrStudentIDCount(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID });
        }
         ...
         *  @param characteristicOfSchoolOrStudentID The ID of the CharacteristicOfSchoolOrStudent for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByCharacteristicOfSchoolOrStudentIDPageCount(characteristicOfSchoolOrStudentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { characteristicOfSchoolOrStudentID: characteristicOfSchoolOrStudentID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByOtherID(otherID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { otherID: otherID }, null, page);
        }

        /** Gets how many DimensionGraphs by OtherID exist. 
         *  @param otherID The ID of the Other for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByOtherIDCount(otherID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { otherID: otherID });
        }

        /** Gets how many pages of DimensionGraphs by OtherID exist.
         *  @param otherID The ID of the Other for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByOtherIDPageCount(otherID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { otherID: otherID });
        }
         ...
         *  @return An Array of DimensionGraphs. */
        public static getByGeographyID(geographyID: number, api: API, callback: IAPICallback<Array<DimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<DimensionGraph>>(Endpoint.fromSelf<Array<DimensionGraph>>(), callback, { geographyID: geographyID }, null, page);
        }

        /** Gets how many DimensionGraphs by GeographyID exist. 
         *  @param geographyID The ID of the Geography for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByGeographyIDCount(geographyID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { geographyID: geographyID });
        }

        /** Gets how many pages of DimensionGraphs by GeographyID exist.
         *  @param geographyID The ID of the Geography for which to retrieve the child DimensionGraphs.
         *  @return An Array of DimensionGraphs. */
        public static getByGeographyIDPageCount(geographyID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { geographyID: geographyID });
        }
    ...
    export class DimensionList extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DimensionList>>, page?: number) {
            api.executeEndpoint<Array<DimensionList>>(Endpoint.fromSelf<Array<DimensionList>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DimensionList>) {
            api.executeEndpoint<DimensionList>(Endpoint.fromSelf<DimensionList>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DimensionList>>, page?: number) {
            api.executeEndpoint<Array<DimensionList>>(Endpoint.fromSelf<Array<DimensionList>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class DisabilityStatus extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DisabilityStatus>>, page?: number) {
            api.executeEndpoint<Array<DisabilityStatus>>(Endpoint.fromSelf<Array<DisabilityStatus>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DisabilityStatus>) {
            api.executeEndpoint<DisabilityStatus>(Endpoint.fromSelf<DisabilityStatus>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DisabilityStatus>>, page?: number) {
            api.executeEndpoint<Array<DisabilityStatus>>(Endpoint.fromSelf<Array<DisabilityStatus>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getDisabilityStatuses(api: API, callback: IAPICallback<Array<DisabilityStatus>>, page?: number) {
         ...
         *  @return An Array of DisabilityStatuses. */
        public static getByParentDisabilityStatusID(disabilityStatusID: number, api: API, callback: IAPICallback<Array<DisabilityStatus>>, page?: number) {
            api.executeEndpoint<Array<DisabilityStatus>>(Endpoint.fromSelf<Array<DisabilityStatus>>(), callback, { disabilityStatusID: disabilityStatusID }, null, page);
        }

        /** Gets how many DisabilityStatuses by ParentDisabilityStatusID exist. 
         *  @return An Array of DisabilityStatuses. */
        public getDisabilityStatusesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DisabilityStatuses.
         *  @return An Array of DisabilityStatuses. */
        public static getByParentDisabilityStatusIDCount(disabilityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { disabilityStatusID: disabilityStatusID });
        }

        /** Gets how many pages of DisabilityStatuses by ParentDisabilityStatusID exist.
         *  @return An Array of DisabilityStatuses. */
        public getDisabilityStatusesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DisabilityStatuses.
         *  @return An Array of DisabilityStatuses. */
        public static getByParentDisabilityStatusIDPageCount(disabilityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { disabilityStatusID: disabilityStatusID });
        }
        ...
        public getParentDisabilityStatus(api: API, callback: IAPICallback<DisabilityStatus>) {
         ...
         *  @return A single DisabilityStatus, or null. */
        public static getParentDisabilityStatusForDisabilityStatus(disabilityStatusID: number, api: API, callback: IAPICallback<DisabilityStatus>) {
    ...
    export class DisabilityStatusRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<DisabilityStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<DisabilityStatusRelation>>(Endpoint.fromSelf<Array<DisabilityStatusRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<DisabilityStatusRelation>) {
            api.executeEndpoint<DisabilityStatusRelation>(Endpoint.fromSelf<DisabilityStatusRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<DisabilityStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<DisabilityStatusRelation>>(Endpoint.fromSelf<Array<DisabilityStatusRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorDisabilityStatusID(disabilityStatusID: number, api: API, callback: IAPICallback<Array<DisabilityStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<DisabilityStatusRelation>>(Endpoint.fromSelf<Array<DisabilityStatusRelation>>(), callback, { disabilityStatusID: disabilityStatusID }, null, page);
        }

        /** Gets how many DisabilityStatusRelations by AncestorDisabilityStatusID exist. 
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DisabilityStatusRelations.
         *  @return An Array of DisabilityStatusRelations. */
        public static getByAncestorDisabilityStatusIDCount(disabilityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { disabilityStatusID: disabilityStatusID });
        }
         ...
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DisabilityStatusRelations.
         *  @return An Array of DisabilityStatusRelations. */
        public static getByAncestorDisabilityStatusIDPageCount(disabilityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { disabilityStatusID: disabilityStatusID });
        }
         ...
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DisabilityStatusRelations.
         *  @return An Array of DisabilityStatusRelations. */
        public static getByDescendantDisabilityStatusID(disabilityStatusID: number, api: API, callback: IAPICallback<Array<DisabilityStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<DisabilityStatusRelation>>(Endpoint.fromSelf<Array<DisabilityStatusRelation>>(), callback, { disabilityStatusID: disabilityStatusID }, null, page);
        }
         ...
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DisabilityStatusRelations.
         *  @return An Array of DisabilityStatusRelations. */
        public static getByDescendantDisabilityStatusIDCount(disabilityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { disabilityStatusID: disabilityStatusID });
        }
         ...
         *  @param disabilityStatusID The ID of the DisabilityStatus for which to retrieve the child DisabilityStatusRelations.
         *  @return An Array of DisabilityStatusRelations. */
        public static getByDescendantDisabilityStatusIDPageCount(disabilityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { disabilityStatusID: disabilityStatusID });
        }
    ...
    export class EducationalAttainment extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<EducationalAttainment>>, page?: number) {
            api.executeEndpoint<Array<EducationalAttainment>>(Endpoint.fromSelf<Array<EducationalAttainment>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<EducationalAttainment>) {
            api.executeEndpoint<EducationalAttainment>(Endpoint.fromSelf<EducationalAttainment>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<EducationalAttainment>>, page?: number) {
            api.executeEndpoint<Array<EducationalAttainment>>(Endpoint.fromSelf<Array<EducationalAttainment>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getEducationalAttainments(api: API, callback: IAPICallback<Array<EducationalAttainment>>, page?: number) {
         ...
         *  @return An Array of EducationalAttainments. */
        public static getByParentEducationalAttainmentID(educationalAttainmentID: number, api: API, callback: IAPICallback<Array<EducationalAttainment>>, page?: number) {
            api.executeEndpoint<Array<EducationalAttainment>>(Endpoint.fromSelf<Array<EducationalAttainment>>(), callback, { educationalAttainmentID: educationalAttainmentID }, null, page);
        }

        /** Gets how many EducationalAttainments by ParentEducationalAttainmentID exist. 
         *  @return An Array of EducationalAttainments. */
        public getEducationalAttainmentsCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child EducationalAttainments.
         *  @return An Array of EducationalAttainments. */
        public static getByParentEducationalAttainmentIDCount(educationalAttainmentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { educationalAttainmentID: educationalAttainmentID });
        }

        /** Gets how many pages of EducationalAttainments by ParentEducationalAttainmentID exist.
         *  @return An Array of EducationalAttainments. */
        public getEducationalAttainmentsPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child EducationalAttainments.
         *  @return An Array of EducationalAttainments. */
        public static getByParentEducationalAttainmentIDPageCount(educationalAttainmentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { educationalAttainmentID: educationalAttainmentID });
        }
        ...
        public getParentEducationalAttainment(api: API, callback: IAPICallback<EducationalAttainment>) {
         ...
         *  @return A single EducationalAttainment, or null. */
        public static getParentEducationalAttainmentForEducationalAttainment(educationalAttainmentID: number, api: API, callback: IAPICallback<EducationalAttainment>) {
    ...
    export class EducationalAttainmentRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<EducationalAttainmentRelation>>, page?: number) {
            api.executeEndpoint<Array<EducationalAttainmentRelation>>(Endpoint.fromSelf<Array<EducationalAttainmentRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<EducationalAttainmentRelation>) {
            api.executeEndpoint<EducationalAttainmentRelation>(Endpoint.fromSelf<EducationalAttainmentRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<EducationalAttainmentRelation>>, page?: number) {
            api.executeEndpoint<Array<EducationalAttainmentRelation>>(Endpoint.fromSelf<Array<EducationalAttainmentRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorEducationalAttainmentID(educationalAttainmentID: number, api: API, callback: IAPICallback<Array<EducationalAttainmentRelation>>, page?: number) {
            api.executeEndpoint<Array<EducationalAttainmentRelation>>(Endpoint.fromSelf<Array<EducationalAttainmentRelation>>(), callback, { educationalAttainmentID: educationalAttainmentID }, null, page);
        }

        /** Gets how many EducationalAttainmentRelations by AncestorEducationalAttainmentID exist. 
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child EducationalAttainmentRelations.
         *  @return An Array of EducationalAttainmentRelations. */
        public static getByAncestorEducationalAttainmentIDCount(educationalAttainmentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { educationalAttainmentID: educationalAttainmentID });
        }
         ...
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child EducationalAttainmentRelations.
         *  @return An Array of EducationalAttainmentRelations. */
        public static getByAncestorEducationalAttainmentIDPageCount(educationalAttainmentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { educationalAttainmentID: educationalAttainmentID });
        }
         ...
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child EducationalAttainmentRelations.
         *  @return An Array of EducationalAttainmentRelations. */
        public static getByDescendantEducationalAttainmentID(educationalAttainmentID: number, api: API, callback: IAPICallback<Array<EducationalAttainmentRelation>>, page?: number) {
            api.executeEndpoint<Array<EducationalAttainmentRelation>>(Endpoint.fromSelf<Array<EducationalAttainmentRelation>>(), callback, { educationalAttainmentID: educationalAttainmentID }, null, page);
        }
         ...
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child EducationalAttainmentRelations.
         *  @return An Array of EducationalAttainmentRelations. */
        public static getByDescendantEducationalAttainmentIDCount(educationalAttainmentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { educationalAttainmentID: educationalAttainmentID });
        }
         ...
         *  @param educationalAttainmentID The ID of the EducationalAttainment for which to retrieve the child EducationalAttainmentRelations.
         *  @return An Array of EducationalAttainmentRelations. */
        public static getByDescendantEducationalAttainmentIDPageCount(educationalAttainmentID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { educationalAttainmentID: educationalAttainmentID });
        }
    ...
    export class FamilyType extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<FamilyType>>, page?: number) {
            api.executeEndpoint<Array<FamilyType>>(Endpoint.fromSelf<Array<FamilyType>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<FamilyType>) {
            api.executeEndpoint<FamilyType>(Endpoint.fromSelf<FamilyType>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<FamilyType>>, page?: number) {
            api.executeEndpoint<Array<FamilyType>>(Endpoint.fromSelf<Array<FamilyType>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getFamilyTypes(api: API, callback: IAPICallback<Array<FamilyType>>, page?: number) {
         ...
         *  @return An Array of FamilyTypes. */
        public static getByParentFamilyTypeID(familyTypeID: number, api: API, callback: IAPICallback<Array<FamilyType>>, page?: number) {
            api.executeEndpoint<Array<FamilyType>>(Endpoint.fromSelf<Array<FamilyType>>(), callback, { familyTypeID: familyTypeID }, null, page);
        }

        /** Gets how many FamilyTypes by ParentFamilyTypeID exist. 
         *  @return An Array of FamilyTypes. */
        public getFamilyTypesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child FamilyTypes.
         *  @return An Array of FamilyTypes. */
        public static getByParentFamilyTypeIDCount(familyTypeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { familyTypeID: familyTypeID });
        }

        /** Gets how many pages of FamilyTypes by ParentFamilyTypeID exist.
         *  @return An Array of FamilyTypes. */
        public getFamilyTypesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child FamilyTypes.
         *  @return An Array of FamilyTypes. */
        public static getByParentFamilyTypeIDPageCount(familyTypeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { familyTypeID: familyTypeID });
        }

        /** Returns the related ParentFamilyType based on the unique ID of the related FamilyType.
         *  @return A single FamilyType, or null. */
        public getParentFamilyType(api: API, callback: IAPICallback<FamilyType>) {
         ...
         *  @return A single FamilyType, or null. */
        public static getParentFamilyTypeForFamilyType(familyTypeID: number, api: API, callback: IAPICallback<FamilyType>) {
    ...
    export class FamilyTypeRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<FamilyTypeRelation>>, page?: number) {
            api.executeEndpoint<Array<FamilyTypeRelation>>(Endpoint.fromSelf<Array<FamilyTypeRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<FamilyTypeRelation>) {
            api.executeEndpoint<FamilyTypeRelation>(Endpoint.fromSelf<FamilyTypeRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<FamilyTypeRelation>>, page?: number) {
            api.executeEndpoint<Array<FamilyTypeRelation>>(Endpoint.fromSelf<Array<FamilyTypeRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorFamilyTypeID(familyTypeID: number, api: API, callback: IAPICallback<Array<FamilyTypeRelation>>, page?: number) {
            api.executeEndpoint<Array<FamilyTypeRelation>>(Endpoint.fromSelf<Array<FamilyTypeRelation>>(), callback, { familyTypeID: familyTypeID }, null, page);
        }

        /** Gets how many FamilyTypeRelations by AncestorFamilyTypeID exist. 
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child FamilyTypeRelations.
         *  @return An Array of FamilyTypeRelations. */
        public static getByAncestorFamilyTypeIDCount(familyTypeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { familyTypeID: familyTypeID });
        }
         ...
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child FamilyTypeRelations.
         *  @return An Array of FamilyTypeRelations. */
        public static getByAncestorFamilyTypeIDPageCount(familyTypeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { familyTypeID: familyTypeID });
        }
         ...
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child FamilyTypeRelations.
         *  @return An Array of FamilyTypeRelations. */
        public static getByDescendantFamilyTypeID(familyTypeID: number, api: API, callback: IAPICallback<Array<FamilyTypeRelation>>, page?: number) {
            api.executeEndpoint<Array<FamilyTypeRelation>>(Endpoint.fromSelf<Array<FamilyTypeRelation>>(), callback, { familyTypeID: familyTypeID }, null, page);
        }
         ...
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child FamilyTypeRelations.
         *  @return An Array of FamilyTypeRelations. */
        public static getByDescendantFamilyTypeIDCount(familyTypeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { familyTypeID: familyTypeID });
        }
         ...
         *  @param familyTypeID The ID of the FamilyType for which to retrieve the child FamilyTypeRelations.
         *  @return An Array of FamilyTypeRelations. */
        public static getByDescendantFamilyTypeIDPageCount(familyTypeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { familyTypeID: familyTypeID });
        }
    ...
    export class Geography extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Geography>>, page?: number) {
            api.executeEndpoint<Array<Geography>>(Endpoint.fromSelf<Array<Geography>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Geography>) {
            api.executeEndpoint<Geography>(Endpoint.fromSelf<Geography>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Geography>>, page?: number) {
            api.executeEndpoint<Array<Geography>>(Endpoint.fromSelf<Array<Geography>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getGeographies(api: API, callback: IAPICallback<Array<Geography>>, page?: number) {
         ...
         *  @return An Array of Geographies. */
        public static getByParentGeographyID(geographyID: number, api: API, callback: IAPICallback<Array<Geography>>, page?: number) {
            api.executeEndpoint<Array<Geography>>(Endpoint.fromSelf<Array<Geography>>(), callback, { geographyID: geographyID }, null, page);
        }

        /** Gets how many Geographies by ParentGeographyID exist. 
         *  @return An Array of Geographies. */
        public getGeographiesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param geographyID The ID of the Geography for which to retrieve the child Geographies.
         *  @return An Array of Geographies. */
        public static getByParentGeographyIDCount(geographyID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { geographyID: geographyID });
        }

        /** Gets how many pages of Geographies by ParentGeographyID exist.
         *  @return An Array of Geographies. */
        public getGeographiesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param geographyID The ID of the Geography for which to retrieve the child Geographies.
         *  @return An Array of Geographies. */
        public static getByParentGeographyIDPageCount(geographyID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { geographyID: geographyID });
        }

        /** Returns the related ParentGeography based on the unique ID of the related Geography.
         *  @return A single Geography, or null. */
        public getParentGeography(api: API, callback: IAPICallback<Geography>) {
         ...
         *  @return A single Geography, or null. */
        public static getParentGeographyForGeography(geographyID: number, api: API, callback: IAPICallback<Geography>) {
    ...
    export class GeographyRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<GeographyRelation>>, page?: number) {
            api.executeEndpoint<Array<GeographyRelation>>(Endpoint.fromSelf<Array<GeographyRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<GeographyRelation>) {
            api.executeEndpoint<GeographyRelation>(Endpoint.fromSelf<GeographyRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<GeographyRelation>>, page?: number) {
            api.executeEndpoint<Array<GeographyRelation>>(Endpoint.fromSelf<Array<GeographyRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorGeographyID(geographyID: number, api: API, callback: IAPICallback<Array<GeographyRelation>>, page?: number) {
            api.executeEndpoint<Array<GeographyRelation>>(Endpoint.fromSelf<Array<GeographyRelation>>(), callback, { geographyID: geographyID }, null, page);
        }

        /** Gets how many GeographyRelations by AncestorGeographyID exist. 
         *  @param geographyID The ID of the Geography for which to retrieve the child GeographyRelations.
         *  @return An Array of GeographyRelations. */
        public static getByAncestorGeographyIDCount(geographyID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { geographyID: geographyID });
        }
         ...
         *  @param geographyID The ID of the Geography for which to retrieve the child GeographyRelations.
         *  @return An Array of GeographyRelations. */
        public static getByAncestorGeographyIDPageCount(geographyID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { geographyID: geographyID });
        }
         ...
         *  @param geographyID The ID of the Geography for which to retrieve the child GeographyRelations.
         *  @return An Array of GeographyRelations. */
        public static getByDescendantGeographyID(geographyID: number, api: API, callback: IAPICallback<Array<GeographyRelation>>, page?: number) {
            api.executeEndpoint<Array<GeographyRelation>>(Endpoint.fromSelf<Array<GeographyRelation>>(), callback, { geographyID: geographyID }, null, page);
        }
         ...
         *  @param geographyID The ID of the Geography for which to retrieve the child GeographyRelations.
         *  @return An Array of GeographyRelations. */
        public static getByDescendantGeographyIDCount(geographyID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { geographyID: geographyID });
        }
         ...
         *  @param geographyID The ID of the Geography for which to retrieve the child GeographyRelations.
         *  @return An Array of GeographyRelations. */
        public static getByDescendantGeographyIDPageCount(geographyID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { geographyID: geographyID });
        }
    ...
    export class GlossaryTerm extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<GlossaryTerm>>, page?: number) {
            api.executeEndpoint<Array<GlossaryTerm>>(Endpoint.fromSelf<Array<GlossaryTerm>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<GlossaryTerm>) {
            api.executeEndpoint<GlossaryTerm>(Endpoint.fromSelf<GlossaryTerm>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<GlossaryTerm>>, page?: number) {
            api.executeEndpoint<Array<GlossaryTerm>>(Endpoint.fromSelf<Array<GlossaryTerm>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getBySourceUrl1ID(urlID: number, api: API, callback: IAPICallback<Array<GlossaryTerm>>, page?: number) {
            api.executeEndpoint<Array<GlossaryTerm>>(Endpoint.fromSelf<Array<GlossaryTerm>>(), callback, { urlID: urlID }, null, page);
        }

        /** Gets how many GlossaryTerms by SourceUrl1ID exist. 
         *  @param urlID The ID of the Url for which to retrieve the child GlossaryTerms.
         *  @return An Array of GlossaryTerms. */
        public static getBySourceUrl1IDCount(urlID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { urlID: urlID });
        }
         ...
         *  @param urlID The ID of the Url for which to retrieve the child GlossaryTerms.
         *  @return An Array of GlossaryTerms. */
        public static getBySourceUrl1IDPageCount(urlID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { urlID: urlID });
        }
         ...
         *  @param urlID The ID of the Url for which to retrieve the child GlossaryTerms.
         *  @return An Array of GlossaryTerms. */
        public static getBySourceUrl2ID(urlID: number, api: API, callback: IAPICallback<Array<GlossaryTerm>>, page?: number) {
            api.executeEndpoint<Array<GlossaryTerm>>(Endpoint.fromSelf<Array<GlossaryTerm>>(), callback, { urlID: urlID }, null, page);
        }
         ...
         *  @param urlID The ID of the Url for which to retrieve the child GlossaryTerms.
         *  @return An Array of GlossaryTerms. */
        public static getBySourceUrl2IDCount(urlID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { urlID: urlID });
        }
         ...
         *  @param urlID The ID of the Url for which to retrieve the child GlossaryTerms.
         *  @return An Array of GlossaryTerms. */
        public static getBySourceUrl2IDPageCount(urlID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { urlID: urlID });
        }
    ...
    export class HealthInsuranceStatus extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<HealthInsuranceStatus>>, page?: number) {
            api.executeEndpoint<Array<HealthInsuranceStatus>>(Endpoint.fromSelf<Array<HealthInsuranceStatus>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<HealthInsuranceStatus>) {
            api.executeEndpoint<HealthInsuranceStatus>(Endpoint.fromSelf<HealthInsuranceStatus>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<HealthInsuranceStatus>>, page?: number) {
            api.executeEndpoint<Array<HealthInsuranceStatus>>(Endpoint.fromSelf<Array<HealthInsuranceStatus>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getHealthInsuranceStatuses(api: API, callback: IAPICallback<Array<HealthInsuranceStatus>>, page?: number) {
         ...
         *  @return An Array of HealthInsuranceStatuses. */
        public static getByParentHealthInsuranceStatusID(healthInsuranceStatusID: number, api: API, callback: IAPICallback<Array<HealthInsuranceStatus>>, page?: number) {
            api.executeEndpoint<Array<HealthInsuranceStatus>>(Endpoint.fromSelf<Array<HealthInsuranceStatus>>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID }, null, page);
        }

        /** Gets how many HealthInsuranceStatuses by ParentHealthInsuranceStatusID exist. 
         *  @return An Array of HealthInsuranceStatuses. */
        public getHealthInsuranceStatusesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child HealthInsuranceStatuses.
         *  @return An Array of HealthInsuranceStatuses. */
        public static getByParentHealthInsuranceStatusIDCount(healthInsuranceStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID });
        }

        /** Gets how many pages of HealthInsuranceStatuses by ParentHealthInsuranceStatusID exist.
         *  @return An Array of HealthInsuranceStatuses. */
        public getHealthInsuranceStatusesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child HealthInsuranceStatuses.
         *  @return An Array of HealthInsuranceStatuses. */
        public static getByParentHealthInsuranceStatusIDPageCount(healthInsuranceStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID });
        }
        ...
        public getParentHealthInsuranceStatus(api: API, callback: IAPICallback<HealthInsuranceStatus>) {
         ...
         *  @return A single HealthInsuranceStatus, or null. */
        public static getParentHealthInsuranceStatusForHealthInsuranceStatus(healthInsuranceStatusID: number, api: API, callback: IAPICallback<HealthInsuranceStatus>) {
    ...
    export class HealthInsuranceStatusRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<HealthInsuranceStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<HealthInsuranceStatusRelation>>(Endpoint.fromSelf<Array<HealthInsuranceStatusRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<HealthInsuranceStatusRelation>) {
            api.executeEndpoint<HealthInsuranceStatusRelation>(Endpoint.fromSelf<HealthInsuranceStatusRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<HealthInsuranceStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<HealthInsuranceStatusRelation>>(Endpoint.fromSelf<Array<HealthInsuranceStatusRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorHealthInsuranceStatusID(healthInsuranceStatusID: number, api: API, callback: IAPICallback<Array<HealthInsuranceStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<HealthInsuranceStatusRelation>>(Endpoint.fromSelf<Array<HealthInsuranceStatusRelation>>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID }, null, page);
        }

        /** Gets how many HealthInsuranceStatusRelations by AncestorHealthInsuranceStatusID exist. 
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child HealthInsuranceStatusRelations.
         *  @return An Array of HealthInsuranceStatusRelations. */
        public static getByAncestorHealthInsuranceStatusIDCount(healthInsuranceStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID });
        }
         ...
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child HealthInsuranceStatusRelations.
         *  @return An Array of HealthInsuranceStatusRelations. */
        public static getByAncestorHealthInsuranceStatusIDPageCount(healthInsuranceStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID });
        }
         ...
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child HealthInsuranceStatusRelations.
         *  @return An Array of HealthInsuranceStatusRelations. */
        public static getByDescendantHealthInsuranceStatusID(healthInsuranceStatusID: number, api: API, callback: IAPICallback<Array<HealthInsuranceStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<HealthInsuranceStatusRelation>>(Endpoint.fromSelf<Array<HealthInsuranceStatusRelation>>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID }, null, page);
        }
         ...
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child HealthInsuranceStatusRelations.
         *  @return An Array of HealthInsuranceStatusRelations. */
        public static getByDescendantHealthInsuranceStatusIDCount(healthInsuranceStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID });
        }
         ...
         *  @param healthInsuranceStatusID The ID of the HealthInsuranceStatus for which to retrieve the child HealthInsuranceStatusRelations.
         *  @return An Array of HealthInsuranceStatusRelations. */
        public static getByDescendantHealthInsuranceStatusIDPageCount(healthInsuranceStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { healthInsuranceStatusID: healthInsuranceStatusID });
        }
    ...
    export class HP2020TSM extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<HP2020TSM>>, page?: number) {
            api.executeEndpoint<Array<HP2020TSM>>(Endpoint.fromSelf<Array<HP2020TSM>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<HP2020TSM>) {
            api.executeEndpoint<HP2020TSM>(Endpoint.fromSelf<HP2020TSM>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<HP2020TSM>>, page?: number) {
            api.executeEndpoint<Array<HP2020TSM>>(Endpoint.fromSelf<Array<HP2020TSM>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class IncomeAndPovertyStatus extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IncomeAndPovertyStatus>>, page?: number) {
            api.executeEndpoint<Array<IncomeAndPovertyStatus>>(Endpoint.fromSelf<Array<IncomeAndPovertyStatus>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IncomeAndPovertyStatus>) {
            api.executeEndpoint<IncomeAndPovertyStatus>(Endpoint.fromSelf<IncomeAndPovertyStatus>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IncomeAndPovertyStatus>>, page?: number) {
            api.executeEndpoint<Array<IncomeAndPovertyStatus>>(Endpoint.fromSelf<Array<IncomeAndPovertyStatus>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getIncomeAndPovertyStatuses(api: API, callback: IAPICallback<Array<IncomeAndPovertyStatus>>, page?: number) {
         ...
         *  @return An Array of IncomeAndPovertyStatuses. */
        public static getByParentIncomeAndPovertyStatusID(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<Array<IncomeAndPovertyStatus>>, page?: number) {
            api.executeEndpoint<Array<IncomeAndPovertyStatus>>(Endpoint.fromSelf<Array<IncomeAndPovertyStatus>>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID }, null, page);
        }

        /** Gets how many IncomeAndPovertyStatuses by ParentIncomeAndPovertyStatusID exist. 
         *  @return An Array of IncomeAndPovertyStatuses. */
        public getIncomeAndPovertyStatusesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child IncomeAndPovertyStatuses.
         *  @return An Array of IncomeAndPovertyStatuses. */
        public static getByParentIncomeAndPovertyStatusIDCount(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID });
        }

        /** Gets how many pages of IncomeAndPovertyStatuses by ParentIncomeAndPovertyStatusID exist.
         *  @return An Array of IncomeAndPovertyStatuses. */
        public getIncomeAndPovertyStatusesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child IncomeAndPovertyStatuses.
         *  @return An Array of IncomeAndPovertyStatuses. */
        public static getByParentIncomeAndPovertyStatusIDPageCount(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID });
        }
        ...
        public getParentIncomeAndPovertyStatus(api: API, callback: IAPICallback<IncomeAndPovertyStatus>) {
         ...
         *  @return A single IncomeAndPovertyStatus, or null. */
        public static getParentIncomeAndPovertyStatusForIncomeAndPovertyStatus(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<IncomeAndPovertyStatus>) {
    ...
    export class IncomeAndPovertyStatusRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IncomeAndPovertyStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<IncomeAndPovertyStatusRelation>>(Endpoint.fromSelf<Array<IncomeAndPovertyStatusRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IncomeAndPovertyStatusRelation>) {
            api.executeEndpoint<IncomeAndPovertyStatusRelation>(Endpoint.fromSelf<IncomeAndPovertyStatusRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IncomeAndPovertyStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<IncomeAndPovertyStatusRelation>>(Endpoint.fromSelf<Array<IncomeAndPovertyStatusRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorIncomeAndPovertyStatusID(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<Array<IncomeAndPovertyStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<IncomeAndPovertyStatusRelation>>(Endpoint.fromSelf<Array<IncomeAndPovertyStatusRelation>>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID }, null, page);
        }

        /** Gets how many IncomeAndPovertyStatusRelations by AncestorIncomeAndPovertyStatusID exist. 
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child IncomeAndPovertyStatusRelations.
         *  @return An Array of IncomeAndPovertyStatusRelations. */
        public static getByAncestorIncomeAndPovertyStatusIDCount(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID });
        }
         ...
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child IncomeAndPovertyStatusRelations.
         *  @return An Array of IncomeAndPovertyStatusRelations. */
        public static getByAncestorIncomeAndPovertyStatusIDPageCount(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID });
        }
         ...
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child IncomeAndPovertyStatusRelations.
         *  @return An Array of IncomeAndPovertyStatusRelations. */
        public static getByDescendantIncomeAndPovertyStatusID(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<Array<IncomeAndPovertyStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<IncomeAndPovertyStatusRelation>>(Endpoint.fromSelf<Array<IncomeAndPovertyStatusRelation>>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID }, null, page);
        }
         ...
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child IncomeAndPovertyStatusRelations.
         *  @return An Array of IncomeAndPovertyStatusRelations. */
        public static getByDescendantIncomeAndPovertyStatusIDCount(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID });
        }
         ...
         *  @param incomeAndPovertyStatusID The ID of the IncomeAndPovertyStatus for which to retrieve the child IncomeAndPovertyStatusRelations.
         *  @return An Array of IncomeAndPovertyStatusRelations. */
        public static getByDescendantIncomeAndPovertyStatusIDPageCount(incomeAndPovertyStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { incomeAndPovertyStatusID: incomeAndPovertyStatusID });
        }
    ...
    export class IndicatorDescriptionDataCategory extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionDataCategory>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDataCategory>>(Endpoint.fromSelf<Array<IndicatorDescriptionDataCategory>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionDataCategory>) {
            api.executeEndpoint<IndicatorDescriptionDataCategory>(Endpoint.fromSelf<IndicatorDescriptionDataCategory>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionDataCategory>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDataCategory>>(Endpoint.fromSelf<Array<IndicatorDescriptionDataCategory>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDataCategory>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDataCategory>>(Endpoint.fromSelf<Array<IndicatorDescriptionDataCategory>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionDataCategories. */
        public static getByDataCategoryID(dataCategoryID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDataCategory>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDataCategory>>(Endpoint.fromSelf<Array<IndicatorDescriptionDataCategory>>(), callback, { dataCategoryID: dataCategoryID }, null, page);
        }

        /** Gets how many IndicatorDescriptionDataCategories by DataCategoryID exist. 
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child IndicatorDescriptionDataCategories.
         *  @return An Array of IndicatorDescriptionDataCategories. */
        public static getByDataCategoryIDCount(dataCategoryID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataCategoryID: dataCategoryID });
        }
         ...
         *  @param dataCategoryID The ID of the DataCategory for which to retrieve the child IndicatorDescriptionDataCategories.
         *  @return An Array of IndicatorDescriptionDataCategories. */
        public static getByDataCategoryIDPageCount(dataCategoryID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dataCategoryID: dataCategoryID });
        }
    ...
    export class IndicatorDescriptionDataSource extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionDataSource>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDataSource>>(Endpoint.fromSelf<Array<IndicatorDescriptionDataSource>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionDataSource>) {
            api.executeEndpoint<IndicatorDescriptionDataSource>(Endpoint.fromSelf<IndicatorDescriptionDataSource>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionDataSource>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDataSource>>(Endpoint.fromSelf<Array<IndicatorDescriptionDataSource>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDataSource>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDataSource>>(Endpoint.fromSelf<Array<IndicatorDescriptionDataSource>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionDataSources. */
        public static getByDataSourceID(dataSourceID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDataSource>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDataSource>>(Endpoint.fromSelf<Array<IndicatorDescriptionDataSource>>(), callback, { dataSourceID: dataSourceID }, null, page);
        }
    ...
    export class IndicatorDescriptionDefaultDimensionGraph extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionDefaultDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDefaultDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDefaultDimensionGraph>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionDefaultDimensionGraph>) {
            api.executeEndpoint<IndicatorDescriptionDefaultDimensionGraph>(Endpoint.fromSelf<IndicatorDescriptionDefaultDimensionGraph>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionDefaultDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDefaultDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDefaultDimensionGraph>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDefaultDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDefaultDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDefaultDimensionGraph>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionDefaultDimensionGraphs. */
        public static getByLocaleLevelID(localeLevelID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDefaultDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDefaultDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDefaultDimensionGraph>>(), callback, { localeLevelID: localeLevelID }, null, page);
        }

        /** Gets how many IndicatorDescriptionDefaultDimensionGraphs by LocaleLevelID exist. 
         *  @param localeLevelID The ID of the LocaleLevel for which to retrieve the child IndicatorDescriptionDefaultDimensionGraphs.
         *  @return An Array of IndicatorDescriptionDefaultDimensionGraphs. */
        public static getByLocaleLevelIDCount(localeLevelID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeLevelID: localeLevelID });
        }

        /** Gets how many pages of IndicatorDescriptionDefaultDimensionGraphs by LocaleLevelID exist.
         *  @param localeLevelID The ID of the LocaleLevel for which to retrieve the child IndicatorDescriptionDefaultDimensionGraphs.
         *  @return An Array of IndicatorDescriptionDefaultDimensionGraphs. */
        public static getByLocaleLevelIDPageCount(localeLevelID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeLevelID: localeLevelID });
        }
         ...
         *  @return An Array of IndicatorDescriptionDefaultDimensionGraphs. */
        public static getByDimensionGraphID(dimensionGraphID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDefaultDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDefaultDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDefaultDimensionGraph>>(), callback, { dimensionGraphID: dimensionGraphID }, null, page);
        }

        /** Gets how many IndicatorDescriptionDefaultDimensionGraphs by DimensionGraphID exist. 
         *  @param dimensionGraphID The ID of the DimensionGraph for which to retrieve the child IndicatorDescriptionDefaultDimensionGraphs.
         *  @return An Array of IndicatorDescriptionDefaultDimensionGraphs. */
        public static getByDimensionGraphIDCount(dimensionGraphID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionGraphID: dimensionGraphID });
        }

        /** Gets how many pages of IndicatorDescriptionDefaultDimensionGraphs by DimensionGraphID exist.
         *  @param dimensionGraphID The ID of the DimensionGraph for which to retrieve the child IndicatorDescriptionDefaultDimensionGraphs.
         *  @return An Array of IndicatorDescriptionDefaultDimensionGraphs. */
        public static getByDimensionGraphIDPageCount(dimensionGraphID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionGraphID: dimensionGraphID });
        }
    ...
    export class IndicatorDescriptionDimension extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionDimension>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimension>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimension>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionDimension>) {
            api.executeEndpoint<IndicatorDescriptionDimension>(Endpoint.fromSelf<IndicatorDescriptionDimension>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimension>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimension>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimension>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimension>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimension>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimension>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionDimensions. */
        public static getByDimensionListID(dimensionListID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimension>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimension>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimension>>(), callback, { dimensionListID: dimensionListID }, null, page);
        }
         ...
         *  @return A single IndicatorDescriptionDimension, or null. */
        public static getByIndicatorDescriptionIDAndDimensionListID(indicatorDescriptionID: string, dimensionListID: string, api: API, callback: IAPICallback<IndicatorDescriptionDimension>) {
    ...
    export class IndicatorDescriptionDimensionGraph extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionGraph>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionDimensionGraph>) {
            api.executeEndpoint<IndicatorDescriptionDimensionGraph>(Endpoint.fromSelf<IndicatorDescriptionDimensionGraph>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionGraph>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionGraph>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionDimensionGraphs. */
        public static getByLocaleLevelID(localeLevelID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionGraph>>(), callback, { localeLevelID: localeLevelID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionDimensionGraphs. */
        public static getByDimensionGraphID(dimensionGraphID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionGraph>>(), callback, { dimensionGraphID: dimensionGraphID }, null, page);
        }
    ...
    export class IndicatorDescriptionDimensionValue extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionValue>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionValue>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionValue>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionDimensionValue>) {
            api.executeEndpoint<IndicatorDescriptionDimensionValue>(Endpoint.fromSelf<IndicatorDescriptionDimensionValue>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionValue>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionValue>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionValue>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionValue>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionValue>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionValue>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionDimensionValues. */
        public static getByDimensionBookID(dimensionBookID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionDimensionValue>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionDimensionValue>>(Endpoint.fromSelf<Array<IndicatorDescriptionDimensionValue>>(), callback, { dimensionBookID: dimensionBookID }, null, page);
        }

        /** Gets how many IndicatorDescriptionDimensionValues by DimensionBookID exist. 
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child IndicatorDescriptionDimensionValues.
         *  @return An Array of IndicatorDescriptionDimensionValues. */
        public static getByDimensionBookIDCount(dimensionBookID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionBookID: dimensionBookID });
        }
         ...
         *  @param dimensionBookID The ID of the DimensionBook for which to retrieve the child IndicatorDescriptionDimensionValues.
         *  @return An Array of IndicatorDescriptionDimensionValues. */
        public static getByDimensionBookIDPageCount(dimensionBookID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { dimensionBookID: dimensionBookID });
        }
         ...
         *  @return A single IndicatorDescriptionDimensionValue, or null. */
        public static getByIndicatorDescriptionIDAndDimensionBookID(indicatorDescriptionID: string, dimensionBookID: string, api: API, callback: IAPICallback<IndicatorDescriptionDimensionValue>) {
    ...
    export class IndicatorDescriptionInitiative extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionInitiative>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionInitiative>>(Endpoint.fromSelf<Array<IndicatorDescriptionInitiative>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionInitiative>) {
            api.executeEndpoint<IndicatorDescriptionInitiative>(Endpoint.fromSelf<IndicatorDescriptionInitiative>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionInitiative>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionInitiative>>(Endpoint.fromSelf<Array<IndicatorDescriptionInitiative>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionInitiative>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionInitiative>>(Endpoint.fromSelf<Array<IndicatorDescriptionInitiative>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionInitiatives. */
        public static getByInitiativeID(initiativeID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionInitiative>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionInitiative>>(Endpoint.fromSelf<Array<IndicatorDescriptionInitiative>>(), callback, { initiativeID: initiativeID }, null, page);
        }
    ...
    export class IndicatorDescriptionIntervention extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionIntervention>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionIntervention>>(Endpoint.fromSelf<Array<IndicatorDescriptionIntervention>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionIntervention>) {
            api.executeEndpoint<IndicatorDescriptionIntervention>(Endpoint.fromSelf<IndicatorDescriptionIntervention>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionIntervention>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionIntervention>>(Endpoint.fromSelf<Array<IndicatorDescriptionIntervention>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionIntervention>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionIntervention>>(Endpoint.fromSelf<Array<IndicatorDescriptionIntervention>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionInterventions. */
        public static getByInterventionID(interventionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionIntervention>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionIntervention>>(Endpoint.fromSelf<Array<IndicatorDescriptionIntervention>>(), callback, { interventionID: interventionID }, null, page);
        }

        /** Gets how many IndicatorDescriptionInterventions by InterventionID exist. 
         *  @param interventionID The ID of the Intervention for which to retrieve the child IndicatorDescriptionInterventions.
         *  @return An Array of IndicatorDescriptionInterventions. */
        public static getByInterventionIDCount(interventionID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { interventionID: interventionID });
        }

        /** Gets how many pages of IndicatorDescriptionInterventions by InterventionID exist.
         *  @param interventionID The ID of the Intervention for which to retrieve the child IndicatorDescriptionInterventions.
         *  @return An Array of IndicatorDescriptionInterventions. */
        public static getByInterventionIDPageCount(interventionID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { interventionID: interventionID });
        }
    ...
    export class IndicatorDescriptionKeyword extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionKeyword>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionKeyword>>(Endpoint.fromSelf<Array<IndicatorDescriptionKeyword>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionKeyword>) {
            api.executeEndpoint<IndicatorDescriptionKeyword>(Endpoint.fromSelf<IndicatorDescriptionKeyword>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionKeyword>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionKeyword>>(Endpoint.fromSelf<Array<IndicatorDescriptionKeyword>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionKeyword>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionKeyword>>(Endpoint.fromSelf<Array<IndicatorDescriptionKeyword>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionKeywords. */
        public static getByKeywordID(keywordID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionKeyword>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionKeyword>>(Endpoint.fromSelf<Array<IndicatorDescriptionKeyword>>(), callback, { keywordID: keywordID }, null, page);
        }

        /** Gets how many IndicatorDescriptionKeywords by KeywordID exist. 
         *  @param keywordID The ID of the Keyword for which to retrieve the child IndicatorDescriptionKeywords.
         *  @return An Array of IndicatorDescriptionKeywords. */
        public static getByKeywordIDCount(keywordID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { keywordID: keywordID });
        }

        /** Gets how many pages of IndicatorDescriptionKeywords by KeywordID exist.
         *  @param keywordID The ID of the Keyword for which to retrieve the child IndicatorDescriptionKeywords.
         *  @return An Array of IndicatorDescriptionKeywords. */
        public static getByKeywordIDPageCount(keywordID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { keywordID: keywordID });
        }
         ...
         *  @return A single IndicatorDescriptionKeyword, or null. */
        public static getByIndicatorDescriptionIDAndKeywordID(indicatorDescriptionID: string, keywordID: string, api: API, callback: IAPICallback<IndicatorDescriptionKeyword>) {
    ...
    export class IndicatorDescriptionLocaleCounty extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleCounty>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleCounty>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleCounty>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionLocaleCounty>) {
            api.executeEndpoint<IndicatorDescriptionLocaleCounty>(Endpoint.fromSelf<IndicatorDescriptionLocaleCounty>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleCounty>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleCounty>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleCounty>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleCounty>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleCounty>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleCounty>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionLocaleCounties. */
        public static getByLocaleID(localeID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleCounty>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleCounty>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleCounty>>(), callback, { localeID: localeID }, null, page);
        }

        /** Gets how many IndicatorDescriptionLocaleCounties by LocaleID exist. 
         *  @param localeID The ID of the Locale for which to retrieve the child IndicatorDescriptionLocaleCounties.
         *  @return An Array of IndicatorDescriptionLocaleCounties. */
        public static getByLocaleIDCount(localeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeID: localeID });
        }

        /** Gets how many pages of IndicatorDescriptionLocaleCounties by LocaleID exist.
         *  @param localeID The ID of the Locale for which to retrieve the child IndicatorDescriptionLocaleCounties.
         *  @return An Array of IndicatorDescriptionLocaleCounties. */
        public static getByLocaleIDPageCount(localeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeID: localeID });
        }
    ...
    export class IndicatorDescriptionLocaleHospitalReferralRegion extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionLocaleHospitalReferralRegion>) {
            api.executeEndpoint<IndicatorDescriptionLocaleHospitalReferralRegion>(Endpoint.fromSelf<IndicatorDescriptionLocaleHospitalReferralRegion>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionLocaleHospitalReferralRegions. */
        public static getByLocaleID(localeID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleHospitalReferralRegion>>(), callback, { localeID: localeID }, null, page);
        }
    ...
    export class IndicatorDescriptionLocaleLevel extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleLevel>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleLevel>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleLevel>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionLocaleLevel>) {
            api.executeEndpoint<IndicatorDescriptionLocaleLevel>(Endpoint.fromSelf<IndicatorDescriptionLocaleLevel>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleLevel>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleLevel>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleLevel>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleLevel>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleLevel>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleLevel>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionLocaleLevels. */
        public static getByLocaleLevelID(localeLevelID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleLevel>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleLevel>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleLevel>>(), callback, { localeLevelID: localeLevelID }, null, page);
        }
    ...
    export class IndicatorDescriptionLocale extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionLocale>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocale>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocale>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionLocale>) {
            api.executeEndpoint<IndicatorDescriptionLocale>(Endpoint.fromSelf<IndicatorDescriptionLocale>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocale>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocale>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocale>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocale>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocale>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocale>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionLocales. */
        public static getByLocaleID(localeID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocale>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocale>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocale>>(), callback, { localeID: localeID }, null, page);
        }
    ...
    export class IndicatorDescriptionLocaleState extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleState>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleState>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleState>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionLocaleState>) {
            api.executeEndpoint<IndicatorDescriptionLocaleState>(Endpoint.fromSelf<IndicatorDescriptionLocaleState>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleState>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleState>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleState>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleState>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleState>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleState>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionLocaleStates. */
        public static getByLocaleID(localeID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionLocaleState>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionLocaleState>>(Endpoint.fromSelf<Array<IndicatorDescriptionLocaleState>>(), callback, { localeID: localeID }, null, page);
        }
    ...
    export class IndicatorDescriptionMethodologyNote extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionMethodologyNote>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionMethodologyNote>>(Endpoint.fromSelf<Array<IndicatorDescriptionMethodologyNote>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionMethodologyNote>) {
            api.executeEndpoint<IndicatorDescriptionMethodologyNote>(Endpoint.fromSelf<IndicatorDescriptionMethodologyNote>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionMethodologyNote>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionMethodologyNote>>(Endpoint.fromSelf<Array<IndicatorDescriptionMethodologyNote>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionMethodologyNote>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionMethodologyNote>>(Endpoint.fromSelf<Array<IndicatorDescriptionMethodologyNote>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
    ...
    export class IndicatorDescriptionMoreInfo extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionMoreInfo>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionMoreInfo>>(Endpoint.fromSelf<Array<IndicatorDescriptionMoreInfo>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionMoreInfo>) {
            api.executeEndpoint<IndicatorDescriptionMoreInfo>(Endpoint.fromSelf<IndicatorDescriptionMoreInfo>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionMoreInfo>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionMoreInfo>>(Endpoint.fromSelf<Array<IndicatorDescriptionMoreInfo>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionMoreInfo>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionMoreInfo>>(Endpoint.fromSelf<Array<IndicatorDescriptionMoreInfo>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionMoreInfos. */
        public static getByUrlID(urlID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionMoreInfo>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionMoreInfo>>(Endpoint.fromSelf<Array<IndicatorDescriptionMoreInfo>>(), callback, { urlID: urlID }, null, page);
        }
    ...
    export class IndicatorDescriptionReference extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionReference>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionReference>>(Endpoint.fromSelf<Array<IndicatorDescriptionReference>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionReference>) {
            api.executeEndpoint<IndicatorDescriptionReference>(Endpoint.fromSelf<IndicatorDescriptionReference>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionReference>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionReference>>(Endpoint.fromSelf<Array<IndicatorDescriptionReference>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionReference>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionReference>>(Endpoint.fromSelf<Array<IndicatorDescriptionReference>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionReferences. */
        public static getByUrlID(urlID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionReference>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionReference>>(Endpoint.fromSelf<Array<IndicatorDescriptionReference>>(), callback, { urlID: urlID }, null, page);
        }
    ...
    export class IndicatorDescriptionResource extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionResource>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionResource>>(Endpoint.fromSelf<Array<IndicatorDescriptionResource>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionResource>) {
            api.executeEndpoint<IndicatorDescriptionResource>(Endpoint.fromSelf<IndicatorDescriptionResource>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionResource>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionResource>>(Endpoint.fromSelf<Array<IndicatorDescriptionResource>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionResource>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionResource>>(Endpoint.fromSelf<Array<IndicatorDescriptionResource>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionResources. */
        public static getByUrlID(urlID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionResource>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionResource>>(Endpoint.fromSelf<Array<IndicatorDescriptionResource>>(), callback, { urlID: urlID }, null, page);
        }
    ...
    export class IndicatorDescription extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescription>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescription>>(Endpoint.fromSelf<Array<IndicatorDescription>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescription>) {
            api.executeEndpoint<IndicatorDescription>(Endpoint.fromSelf<IndicatorDescription>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescription>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescription>>(Endpoint.fromSelf<Array<IndicatorDescription>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByValueLabelID(valueLabelID: number, api: API, callback: IAPICallback<Array<IndicatorDescription>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescription>>(Endpoint.fromSelf<Array<IndicatorDescription>>(), callback, { valueLabelID: valueLabelID }, null, page);
        }

        /** Gets how many IndicatorDescriptions by ValueLabelID exist. 
         *  @param valueLabelID The ID of the ValueLabel for which to retrieve the child IndicatorDescriptions.
         *  @return An Array of IndicatorDescriptions. */
        public static getByValueLabelIDCount(valueLabelID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { valueLabelID: valueLabelID });
        }

        /** Gets how many pages of IndicatorDescriptions by ValueLabelID exist.
         *  @param valueLabelID The ID of the ValueLabel for which to retrieve the child IndicatorDescriptions.
         *  @return An Array of IndicatorDescriptions. */
        public static getByValueLabelIDPageCount(valueLabelID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { valueLabelID: valueLabelID });
        }
    ...
    export class IndicatorDescriptionHP2020 extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionHP2020>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionHP2020>>(Endpoint.fromSelf<Array<IndicatorDescriptionHP2020>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionHP2020>) {
            api.executeEndpoint<IndicatorDescriptionHP2020>(Endpoint.fromSelf<IndicatorDescriptionHP2020>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionHP2020>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionHP2020>>(Endpoint.fromSelf<Array<IndicatorDescriptionHP2020>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionHP2020>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionHP2020>>(Endpoint.fromSelf<Array<IndicatorDescriptionHP2020>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionHP2020s. */
        public static getByHP2020TSMID(hP2020TSMID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionHP2020>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionHP2020>>(Endpoint.fromSelf<Array<IndicatorDescriptionHP2020>>(), callback, { hP2020TSMID: hP2020TSMID }, null, page);
        }

        /** Gets how many IndicatorDescriptionHP2020s by HP2020TSMID exist. 
         *  @param hP2020TSMID The ID of the HP2020TSM for which to retrieve the child IndicatorDescriptionHP2020s.
         *  @return An Array of IndicatorDescriptionHP2020s. */
        public static getByHP2020TSMIDCount(hP2020TSMID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { hP2020TSMID: hP2020TSMID });
        }

        /** Gets how many pages of IndicatorDescriptionHP2020s by HP2020TSMID exist.
         *  @param hP2020TSMID The ID of the HP2020TSM for which to retrieve the child IndicatorDescriptionHP2020s.
         *  @return An Array of IndicatorDescriptionHP2020s. */
        public static getByHP2020TSMIDPageCount(hP2020TSMID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { hP2020TSMID: hP2020TSMID });
        }
    ...
    export class IndicatorDescriptionTimeFrame extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionTimeFrame>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionTimeFrame>>(Endpoint.fromSelf<Array<IndicatorDescriptionTimeFrame>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionTimeFrame>) {
            api.executeEndpoint<IndicatorDescriptionTimeFrame>(Endpoint.fromSelf<IndicatorDescriptionTimeFrame>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionTimeFrame>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionTimeFrame>>(Endpoint.fromSelf<Array<IndicatorDescriptionTimeFrame>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionTimeFrame>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionTimeFrame>>(Endpoint.fromSelf<Array<IndicatorDescriptionTimeFrame>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionTimeFrames. */
        public static getByTimeframeID(timeframeID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionTimeFrame>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionTimeFrame>>(Endpoint.fromSelf<Array<IndicatorDescriptionTimeFrame>>(), callback, { timeframeID: timeframeID }, null, page);
        }

        /** Gets how many IndicatorDescriptionTimeFrames by TimeframeID exist. 
         *  @param timeframeID The ID of the Timeframe for which to retrieve the child IndicatorDescriptionTimeFrames.
         *  @return An Array of IndicatorDescriptionTimeFrames. */
        public static getByTimeframeIDCount(timeframeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { timeframeID: timeframeID });
        }

        /** Gets how many pages of IndicatorDescriptionTimeFrames by TimeframeID exist.
         *  @param timeframeID The ID of the Timeframe for which to retrieve the child IndicatorDescriptionTimeFrames.
         *  @return An Array of IndicatorDescriptionTimeFrames. */
        public static getByTimeframeIDPageCount(timeframeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { timeframeID: timeframeID });
        }
    ...
    export class IndicatorDescriptionYear extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDescriptionYear>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionYear>>(Endpoint.fromSelf<Array<IndicatorDescriptionYear>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDescriptionYear>) {
            api.executeEndpoint<IndicatorDescriptionYear>(Endpoint.fromSelf<IndicatorDescriptionYear>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDescriptionYear>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionYear>>(Endpoint.fromSelf<Array<IndicatorDescriptionYear>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionYear>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionYear>>(Endpoint.fromSelf<Array<IndicatorDescriptionYear>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDescriptionYears. */
        public static getByYearID(yearID: number, api: API, callback: IAPICallback<Array<IndicatorDescriptionYear>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDescriptionYear>>(Endpoint.fromSelf<Array<IndicatorDescriptionYear>>(), callback, { yearID: yearID }, null, page);
        }

        /** Gets how many IndicatorDescriptionYears by YearID exist. 
         *  @param yearID The ID of the Year for which to retrieve the child IndicatorDescriptionYears.
         *  @return An Array of IndicatorDescriptionYears. */
        public static getByYearIDCount(yearID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { yearID: yearID });
        }

        /** Gets how many pages of IndicatorDescriptionYears by YearID exist.
         *  @param yearID The ID of the Year for which to retrieve the child IndicatorDescriptionYears.
         *  @return An Array of IndicatorDescriptionYears. */
        public static getByYearIDPageCount(yearID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { yearID: yearID });
        }
         ...
         *  @return A single IndicatorDescriptionYear, or null. */
        public static getByIndicatorDescriptionIDAndYearID(indicatorDescriptionID: string, yearID: string, api: API, callback: IAPICallback<IndicatorDescriptionYear>) {
    ...
    export class IndicatorDimensionGraph extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDimensionGraph>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDimensionGraph>) {
            api.executeEndpoint<IndicatorDimensionGraph>(Endpoint.fromSelf<IndicatorDimensionGraph>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDimensionGraph>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<IndicatorDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDimensionGraph>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDimensionGraphs. */
        public static getByLocaleLevelID(localeLevelID: number, api: API, callback: IAPICallback<Array<IndicatorDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDimensionGraph>>(), callback, { localeLevelID: localeLevelID }, null, page);
        }
         ...
         *  @return An Array of IndicatorDimensionGraphs. */
        public static getByDimensionGraphID(dimensionGraphID: number, api: API, callback: IAPICallback<Array<IndicatorDimensionGraph>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimensionGraph>>(Endpoint.fromSelf<Array<IndicatorDimensionGraph>>(), callback, { dimensionGraphID: dimensionGraphID }, null, page);
        }
    ...
    export class IndicatorDimension extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<IndicatorDimension>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimension>>(Endpoint.fromSelf<Array<IndicatorDimension>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<IndicatorDimension>) {
            api.executeEndpoint<IndicatorDimension>(Endpoint.fromSelf<IndicatorDimension>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<IndicatorDimension>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimension>>(Endpoint.fromSelf<Array<IndicatorDimension>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorID(indicatorID: number, api: API, callback: IAPICallback<Array<IndicatorDimension>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimension>>(Endpoint.fromSelf<Array<IndicatorDimension>>(), callback, { indicatorID: indicatorID }, null, page);
        }

        /** Gets how many IndicatorDimensions by IndicatorID exist. 
         *  @param indicatorID The ID of the Indicator for which to retrieve the child IndicatorDimensions.
         *  @return An Array of IndicatorDimensions. */
        public static getByIndicatorIDCount(indicatorID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { indicatorID: indicatorID });
        }

        /** Gets how many pages of IndicatorDimensions by IndicatorID exist.
         *  @param indicatorID The ID of the Indicator for which to retrieve the child IndicatorDimensions.
         *  @return An Array of IndicatorDimensions. */
        public static getByIndicatorIDPageCount(indicatorID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { indicatorID: indicatorID });
        }
         ...
         *  @return An Array of IndicatorDimensions. */
        public static getByDimensionBookID(dimensionBookID: number, api: API, callback: IAPICallback<Array<IndicatorDimension>>, page?: number) {
            api.executeEndpoint<Array<IndicatorDimension>>(Endpoint.fromSelf<Array<IndicatorDimension>>(), callback, { dimensionBookID: dimensionBookID }, null, page);
        }
         ...
         *  @return A single IndicatorDimension, or null. */
        public static getByDimensionBookIDAndIndicatorID(dimensionBookID: string, indicatorID: string, api: API, callback: IAPICallback<IndicatorDimension>) {
    ...
    export class Indicator extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Indicator>>, page?: number) {
            api.executeEndpoint<Array<Indicator>>(Endpoint.fromSelf<Array<Indicator>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Indicator>) {
            api.executeEndpoint<Indicator>(Endpoint.fromSelf<Indicator>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Indicator>>, page?: number) {
            api.executeEndpoint<Array<Indicator>>(Endpoint.fromSelf<Array<Indicator>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByIndicatorDescriptionID(indicatorDescriptionID: number, api: API, callback: IAPICallback<Array<Indicator>>, page?: number) {
            api.executeEndpoint<Array<Indicator>>(Endpoint.fromSelf<Array<Indicator>>(), callback, { indicatorDescriptionID: indicatorDescriptionID }, null, page);
        }
         ...
         *  @return An Array of Indicators. */
        public static getByTimeframeID(timeframeID: number, api: API, callback: IAPICallback<Array<Indicator>>, page?: number) {
            api.executeEndpoint<Array<Indicator>>(Endpoint.fromSelf<Array<Indicator>>(), callback, { timeframeID: timeframeID }, null, page);
        }
         ...
         *  @return An Array of Indicators. */
        public static getByLocaleID(localeID: number, api: API, callback: IAPICallback<Array<Indicator>>, page?: number) {
            api.executeEndpoint<Array<Indicator>>(Endpoint.fromSelf<Array<Indicator>>(), callback, { localeID: localeID }, null, page);
        }
         ...
         *  @return An Array of Indicators. */
        public static getByDimensionGraphID(dimensionGraphID: number, api: API, callback: IAPICallback<Array<Indicator>>, page?: number) {
            api.executeEndpoint<Array<Indicator>>(Endpoint.fromSelf<Array<Indicator>>(), callback, { dimensionGraphID: dimensionGraphID }, null, page);
        }
         ...
         *  @return An Array of Indicators. */
        public static getByModifierGraphID(modifierGraphID: number, api: API, callback: IAPICallback<Array<Indicator>>, page?: number) {
            api.executeEndpoint<Array<Indicator>>(Endpoint.fromSelf<Array<Indicator>>(), callback, { modifierGraphID: modifierGraphID }, null, page);
        }

        /** Gets how many Indicators by ModifierGraphID exist. 
         *  @param modifierGraphID The ID of the ModifierGraph for which to retrieve the child Indicators.
         *  @return An Array of Indicators. */
        public static getByModifierGraphIDCount(modifierGraphID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierGraphID: modifierGraphID });
        }

        /** Gets how many pages of Indicators by ModifierGraphID exist.
         *  @param modifierGraphID The ID of the ModifierGraph for which to retrieve the child Indicators.
         *  @return An Array of Indicators. */
        public static getByModifierGraphIDPageCount(modifierGraphID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierGraphID: modifierGraphID });
        }
    ...
    export class Initiative extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Initiative>>, page?: number) {
            api.executeEndpoint<Array<Initiative>>(Endpoint.fromSelf<Array<Initiative>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Initiative>) {
            api.executeEndpoint<Initiative>(Endpoint.fromSelf<Initiative>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Initiative>>, page?: number) {
            api.executeEndpoint<Array<Initiative>>(Endpoint.fromSelf<Array<Initiative>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class Intervention extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Intervention>>, page?: number) {
            api.executeEndpoint<Array<Intervention>>(Endpoint.fromSelf<Array<Intervention>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Intervention>) {
            api.executeEndpoint<Intervention>(Endpoint.fromSelf<Intervention>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Intervention>>, page?: number) {
            api.executeEndpoint<Array<Intervention>>(Endpoint.fromSelf<Array<Intervention>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByUrlID(urlID: number, api: API, callback: IAPICallback<Array<Intervention>>, page?: number) {
            api.executeEndpoint<Array<Intervention>>(Endpoint.fromSelf<Array<Intervention>>(), callback, { urlID: urlID }, null, page);
        }
    ...
    export class Keyword extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Keyword>>, page?: number) {
            api.executeEndpoint<Array<Keyword>>(Endpoint.fromSelf<Array<Keyword>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Keyword>) {
            api.executeEndpoint<Keyword>(Endpoint.fromSelf<Keyword>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Keyword>>, page?: number) {
            api.executeEndpoint<Array<Keyword>>(Endpoint.fromSelf<Array<Keyword>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class LocaleLevel extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<LocaleLevel>>, page?: number) {
            api.executeEndpoint<Array<LocaleLevel>>(Endpoint.fromSelf<Array<LocaleLevel>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<LocaleLevel>) {
            api.executeEndpoint<LocaleLevel>(Endpoint.fromSelf<LocaleLevel>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<LocaleLevel>>, page?: number) {
            api.executeEndpoint<Array<LocaleLevel>>(Endpoint.fromSelf<Array<LocaleLevel>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class LocaleRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<LocaleRelation>>, page?: number) {
            api.executeEndpoint<Array<LocaleRelation>>(Endpoint.fromSelf<Array<LocaleRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<LocaleRelation>) {
            api.executeEndpoint<LocaleRelation>(Endpoint.fromSelf<LocaleRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<LocaleRelation>>, page?: number) {
            api.executeEndpoint<Array<LocaleRelation>>(Endpoint.fromSelf<Array<LocaleRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorLocaleID(localeID: number, api: API, callback: IAPICallback<Array<LocaleRelation>>, page?: number) {
            api.executeEndpoint<Array<LocaleRelation>>(Endpoint.fromSelf<Array<LocaleRelation>>(), callback, { localeID: localeID }, null, page);
        }

        /** Gets how many LocaleRelations by AncestorLocaleID exist. 
         *  @param localeID The ID of the Locale for which to retrieve the child LocaleRelations.
         *  @return An Array of LocaleRelations. */
        public static getByAncestorLocaleIDCount(localeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeID: localeID });
        }
         ...
         *  @param localeID The ID of the Locale for which to retrieve the child LocaleRelations.
         *  @return An Array of LocaleRelations. */
        public static getByAncestorLocaleIDPageCount(localeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeID: localeID });
        }
         ...
         *  @param localeID The ID of the Locale for which to retrieve the child LocaleRelations.
         *  @return An Array of LocaleRelations. */
        public static getByDescendantLocaleID(localeID: number, api: API, callback: IAPICallback<Array<LocaleRelation>>, page?: number) {
            api.executeEndpoint<Array<LocaleRelation>>(Endpoint.fromSelf<Array<LocaleRelation>>(), callback, { localeID: localeID }, null, page);
        }
         ...
         *  @param localeID The ID of the Locale for which to retrieve the child LocaleRelations.
         *  @return An Array of LocaleRelations. */
        public static getByDescendantLocaleIDCount(localeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeID: localeID });
        }
         ...
         *  @param localeID The ID of the Locale for which to retrieve the child LocaleRelations.
         *  @return An Array of LocaleRelations. */
        public static getByDescendantLocaleIDPageCount(localeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeID: localeID });
        }
         ...
         *  @return A single LocaleRelation, or null. */
        public static getByAncestorLocaleIDAndDescendantLocaleID(ancestorLocaleID: string, descendantLocaleID: string, api: API, callback: IAPICallback<LocaleRelation>) {
    ...
    export class Locale extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Locale>>, page?: number) {
            api.executeEndpoint<Array<Locale>>(Endpoint.fromSelf<Array<Locale>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Locale>) {
            api.executeEndpoint<Locale>(Endpoint.fromSelf<Locale>(), callback, { id: id });
        }

        /** Returns a filtered collection of Locales based on the provided filter.
         *  @param filter The Filter to apply.
         *  @return All Locales which match the provided filter. */
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Locale>>, page?: number) {
            api.executeEndpoint<Array<Locale>>(Endpoint.fromSelf<Array<Locale>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getLocales(api: API, callback: IAPICallback<Array<Locale>>, page?: number) {
         ...
         *  @return An Array of Locales. */
        public static getByParentLocaleID(localeID: number, api: API, callback: IAPICallback<Array<Locale>>, page?: number) {
            api.executeEndpoint<Array<Locale>>(Endpoint.fromSelf<Array<Locale>>(), callback, { localeID: localeID }, null, page);
        }

        /** Gets how many Locales by ParentLocaleID exist. 
         *  @return An Array of Locales. */
        public getLocalesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param localeID The ID of the Locale for which to retrieve the child Locales.
         *  @return An Array of Locales. */
        public static getByParentLocaleIDCount(localeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeID: localeID });
        }

        /** Gets how many pages of Locales by ParentLocaleID exist.
         *  @return An Array of Locales. */
        public getLocalesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param localeID The ID of the Locale for which to retrieve the child Locales.
         *  @return An Array of Locales. */
        public static getByParentLocaleIDPageCount(localeID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { localeID: localeID });
        }

        /** Returns the related ParentLocale based on the unique ID of the related Locale.
         *  @return A single Locale, or null. */
        public getParentLocale(api: API, callback: IAPICallback<Locale>) {
         ...
         *  @return A single Locale, or null. */
        public static getParentLocaleForLocale(localeID: number, api: API, callback: IAPICallback<Locale>) {
         ...
         *  @return An Array of Locales. */
        public static getByLocaleLevelID(localeLevelID: number, api: API, callback: IAPICallback<Array<Locale>>, page?: number) {
            api.executeEndpoint<Array<Locale>>(Endpoint.fromSelf<Array<Locale>>(), callback, { localeLevelID: localeLevelID }, null, page);
        }
    ...
    export class MaritalStatus extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<MaritalStatus>>, page?: number) {
            api.executeEndpoint<Array<MaritalStatus>>(Endpoint.fromSelf<Array<MaritalStatus>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<MaritalStatus>) {
            api.executeEndpoint<MaritalStatus>(Endpoint.fromSelf<MaritalStatus>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<MaritalStatus>>, page?: number) {
            api.executeEndpoint<Array<MaritalStatus>>(Endpoint.fromSelf<Array<MaritalStatus>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getMaritalStatuses(api: API, callback: IAPICallback<Array<MaritalStatus>>, page?: number) {
         ...
         *  @return An Array of MaritalStatuses. */
        public static getByParentMaritalStatusID(maritalStatusID: number, api: API, callback: IAPICallback<Array<MaritalStatus>>, page?: number) {
            api.executeEndpoint<Array<MaritalStatus>>(Endpoint.fromSelf<Array<MaritalStatus>>(), callback, { maritalStatusID: maritalStatusID }, null, page);
        }

        /** Gets how many MaritalStatuses by ParentMaritalStatusID exist. 
         *  @return An Array of MaritalStatuses. */
        public getMaritalStatusesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child MaritalStatuses.
         *  @return An Array of MaritalStatuses. */
        public static getByParentMaritalStatusIDCount(maritalStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { maritalStatusID: maritalStatusID });
        }

        /** Gets how many pages of MaritalStatuses by ParentMaritalStatusID exist.
         *  @return An Array of MaritalStatuses. */
        public getMaritalStatusesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child MaritalStatuses.
         *  @return An Array of MaritalStatuses. */
        public static getByParentMaritalStatusIDPageCount(maritalStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { maritalStatusID: maritalStatusID });
        }
        ...
        public getParentMaritalStatus(api: API, callback: IAPICallback<MaritalStatus>) {
         ...
         *  @return A single MaritalStatus, or null. */
        public static getParentMaritalStatusForMaritalStatus(maritalStatusID: number, api: API, callback: IAPICallback<MaritalStatus>) {
    ...
    export class MaritalStatusRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<MaritalStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<MaritalStatusRelation>>(Endpoint.fromSelf<Array<MaritalStatusRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<MaritalStatusRelation>) {
            api.executeEndpoint<MaritalStatusRelation>(Endpoint.fromSelf<MaritalStatusRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<MaritalStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<MaritalStatusRelation>>(Endpoint.fromSelf<Array<MaritalStatusRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorMaritalStatusID(maritalStatusID: number, api: API, callback: IAPICallback<Array<MaritalStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<MaritalStatusRelation>>(Endpoint.fromSelf<Array<MaritalStatusRelation>>(), callback, { maritalStatusID: maritalStatusID }, null, page);
        }

        /** Gets how many MaritalStatusRelations by AncestorMaritalStatusID exist. 
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child MaritalStatusRelations.
         *  @return An Array of MaritalStatusRelations. */
        public static getByAncestorMaritalStatusIDCount(maritalStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { maritalStatusID: maritalStatusID });
        }
         ...
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child MaritalStatusRelations.
         *  @return An Array of MaritalStatusRelations. */
        public static getByAncestorMaritalStatusIDPageCount(maritalStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { maritalStatusID: maritalStatusID });
        }
         ...
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child MaritalStatusRelations.
         *  @return An Array of MaritalStatusRelations. */
        public static getByDescendantMaritalStatusID(maritalStatusID: number, api: API, callback: IAPICallback<Array<MaritalStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<MaritalStatusRelation>>(Endpoint.fromSelf<Array<MaritalStatusRelation>>(), callback, { maritalStatusID: maritalStatusID }, null, page);
        }
         ...
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child MaritalStatusRelations.
         *  @return An Array of MaritalStatusRelations. */
        public static getByDescendantMaritalStatusIDCount(maritalStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { maritalStatusID: maritalStatusID });
        }
         ...
         *  @param maritalStatusID The ID of the MaritalStatus for which to retrieve the child MaritalStatusRelations.
         *  @return An Array of MaritalStatusRelations. */
        public static getByDescendantMaritalStatusIDPageCount(maritalStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { maritalStatusID: maritalStatusID });
        }
    ...
    export class Modifier extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Modifier>>, page?: number) {
            api.executeEndpoint<Array<Modifier>>(Endpoint.fromSelf<Array<Modifier>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Modifier>) {
            api.executeEndpoint<Modifier>(Endpoint.fromSelf<Modifier>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Modifier>>, page?: number) {
            api.executeEndpoint<Array<Modifier>>(Endpoint.fromSelf<Array<Modifier>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getModifiers(api: API, callback: IAPICallback<Array<Modifier>>, page?: number) {
         ...
         *  @return An Array of Modifiers. */
        public static getByParentModifierID(modifierID: number, api: API, callback: IAPICallback<Array<Modifier>>, page?: number) {
            api.executeEndpoint<Array<Modifier>>(Endpoint.fromSelf<Array<Modifier>>(), callback, { modifierID: modifierID }, null, page);
        }

        /** Gets how many Modifiers by ParentModifierID exist. 
         *  @return An Array of Modifiers. */
        public getModifiersCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child Modifiers.
         *  @return An Array of Modifiers. */
        public static getByParentModifierIDCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }

        /** Gets how many pages of Modifiers by ParentModifierID exist.
         *  @return An Array of Modifiers. */
        public getModifiersPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child Modifiers.
         *  @return An Array of Modifiers. */
        public static getByParentModifierIDPageCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }

        /** Returns the related ParentModifier based on the unique ID of the related Modifier.
         *  @return A single Modifier, or null. */
        public getParentModifier(api: API, callback: IAPICallback<Modifier>) {
         ...
         *  @return A single Modifier, or null. */
        public static getParentModifierForModifier(modifierID: number, api: API, callback: IAPICallback<Modifier>) {
    ...
    export class ModifierGraph extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<ModifierGraph>>, page?: number) {
            api.executeEndpoint<Array<ModifierGraph>>(Endpoint.fromSelf<Array<ModifierGraph>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<ModifierGraph>) {
            api.executeEndpoint<ModifierGraph>(Endpoint.fromSelf<ModifierGraph>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<ModifierGraph>>, page?: number) {
            api.executeEndpoint<Array<ModifierGraph>>(Endpoint.fromSelf<Array<ModifierGraph>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByModifier1ID(modifierID: number, api: API, callback: IAPICallback<Array<ModifierGraph>>, page?: number) {
            api.executeEndpoint<Array<ModifierGraph>>(Endpoint.fromSelf<Array<ModifierGraph>>(), callback, { modifierID: modifierID }, null, page);
        }

        /** Gets how many ModifierGraphs by Modifier1ID exist. 
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier1IDCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier1IDPageCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier2ID(modifierID: number, api: API, callback: IAPICallback<Array<ModifierGraph>>, page?: number) {
            api.executeEndpoint<Array<ModifierGraph>>(Endpoint.fromSelf<Array<ModifierGraph>>(), callback, { modifierID: modifierID }, null, page);
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier2IDCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier2IDPageCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier3ID(modifierID: number, api: API, callback: IAPICallback<Array<ModifierGraph>>, page?: number) {
            api.executeEndpoint<Array<ModifierGraph>>(Endpoint.fromSelf<Array<ModifierGraph>>(), callback, { modifierID: modifierID }, null, page);
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier3IDCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier3IDPageCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier4ID(modifierID: number, api: API, callback: IAPICallback<Array<ModifierGraph>>, page?: number) {
            api.executeEndpoint<Array<ModifierGraph>>(Endpoint.fromSelf<Array<ModifierGraph>>(), callback, { modifierID: modifierID }, null, page);
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier4IDCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier4IDPageCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier5ID(modifierID: number, api: API, callback: IAPICallback<Array<ModifierGraph>>, page?: number) {
            api.executeEndpoint<Array<ModifierGraph>>(Endpoint.fromSelf<Array<ModifierGraph>>(), callback, { modifierID: modifierID }, null, page);
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier5IDCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
         ...
         *  @param modifierID The ID of the Modifier for which to retrieve the child ModifierGraphs.
         *  @return An Array of ModifierGraphs. */
        public static getByModifier5IDPageCount(modifierID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { modifierID: modifierID });
        }
    ...
    export class ObesityStatus extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<ObesityStatus>>, page?: number) {
            api.executeEndpoint<Array<ObesityStatus>>(Endpoint.fromSelf<Array<ObesityStatus>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<ObesityStatus>) {
            api.executeEndpoint<ObesityStatus>(Endpoint.fromSelf<ObesityStatus>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<ObesityStatus>>, page?: number) {
            api.executeEndpoint<Array<ObesityStatus>>(Endpoint.fromSelf<Array<ObesityStatus>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getObesityStatuses(api: API, callback: IAPICallback<Array<ObesityStatus>>, page?: number) {
         ...
         *  @return An Array of ObesityStatuses. */
        public static getByParentObesityStatusID(obesityStatusID: number, api: API, callback: IAPICallback<Array<ObesityStatus>>, page?: number) {
            api.executeEndpoint<Array<ObesityStatus>>(Endpoint.fromSelf<Array<ObesityStatus>>(), callback, { obesityStatusID: obesityStatusID }, null, page);
        }

        /** Gets how many ObesityStatuses by ParentObesityStatusID exist. 
         *  @return An Array of ObesityStatuses. */
        public getObesityStatusesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child ObesityStatuses.
         *  @return An Array of ObesityStatuses. */
        public static getByParentObesityStatusIDCount(obesityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { obesityStatusID: obesityStatusID });
        }

        /** Gets how many pages of ObesityStatuses by ParentObesityStatusID exist.
         *  @return An Array of ObesityStatuses. */
        public getObesityStatusesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child ObesityStatuses.
         *  @return An Array of ObesityStatuses. */
        public static getByParentObesityStatusIDPageCount(obesityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { obesityStatusID: obesityStatusID });
        }
        ...
        public getParentObesityStatus(api: API, callback: IAPICallback<ObesityStatus>) {
         ...
         *  @return A single ObesityStatus, or null. */
        public static getParentObesityStatusForObesityStatus(obesityStatusID: number, api: API, callback: IAPICallback<ObesityStatus>) {
    ...
    export class ObesityStatusRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<ObesityStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<ObesityStatusRelation>>(Endpoint.fromSelf<Array<ObesityStatusRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<ObesityStatusRelation>) {
            api.executeEndpoint<ObesityStatusRelation>(Endpoint.fromSelf<ObesityStatusRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<ObesityStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<ObesityStatusRelation>>(Endpoint.fromSelf<Array<ObesityStatusRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorObesityStatusID(obesityStatusID: number, api: API, callback: IAPICallback<Array<ObesityStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<ObesityStatusRelation>>(Endpoint.fromSelf<Array<ObesityStatusRelation>>(), callback, { obesityStatusID: obesityStatusID }, null, page);
        }

        /** Gets how many ObesityStatusRelations by AncestorObesityStatusID exist. 
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child ObesityStatusRelations.
         *  @return An Array of ObesityStatusRelations. */
        public static getByAncestorObesityStatusIDCount(obesityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { obesityStatusID: obesityStatusID });
        }
         ...
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child ObesityStatusRelations.
         *  @return An Array of ObesityStatusRelations. */
        public static getByAncestorObesityStatusIDPageCount(obesityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { obesityStatusID: obesityStatusID });
        }
         ...
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child ObesityStatusRelations.
         *  @return An Array of ObesityStatusRelations. */
        public static getByDescendantObesityStatusID(obesityStatusID: number, api: API, callback: IAPICallback<Array<ObesityStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<ObesityStatusRelation>>(Endpoint.fromSelf<Array<ObesityStatusRelation>>(), callback, { obesityStatusID: obesityStatusID }, null, page);
        }
         ...
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child ObesityStatusRelations.
         *  @return An Array of ObesityStatusRelations. */
        public static getByDescendantObesityStatusIDCount(obesityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { obesityStatusID: obesityStatusID });
        }
         ...
         *  @param obesityStatusID The ID of the ObesityStatus for which to retrieve the child ObesityStatusRelations.
         *  @return An Array of ObesityStatusRelations. */
        public static getByDescendantObesityStatusIDPageCount(obesityStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { obesityStatusID: obesityStatusID });
        }
    ...
    export class Other extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Other>>, page?: number) {
            api.executeEndpoint<Array<Other>>(Endpoint.fromSelf<Array<Other>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Other>) {
            api.executeEndpoint<Other>(Endpoint.fromSelf<Other>(), callback, { id: id });
        }

        /** Returns a filtered collection of Others based on the provided filter.
         *  @param filter The Filter to apply.
         *  @return All Others which match the provided filter. */
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Other>>, page?: number) {
            api.executeEndpoint<Array<Other>>(Endpoint.fromSelf<Array<Other>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getOthers(api: API, callback: IAPICallback<Array<Other>>, page?: number) {
         ...
         *  @return An Array of Others. */
        public static getByParentOtherID(otherID: number, api: API, callback: IAPICallback<Array<Other>>, page?: number) {
            api.executeEndpoint<Array<Other>>(Endpoint.fromSelf<Array<Other>>(), callback, { otherID: otherID }, null, page);
        }

        /** Gets how many Others by ParentOtherID exist. 
         *  @return An Array of Others. */
        public getOthersCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param otherID The ID of the Other for which to retrieve the child Others.
         *  @return An Array of Others. */
        public static getByParentOtherIDCount(otherID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { otherID: otherID });
        }

        /** Gets how many pages of Others by ParentOtherID exist.
         *  @return An Array of Others. */
        public getOthersPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param otherID The ID of the Other for which to retrieve the child Others.
         *  @return An Array of Others. */
        public static getByParentOtherIDPageCount(otherID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { otherID: otherID });
        }

        /** Returns the related ParentOther based on the unique ID of the related Other.
         *  @return A single Other, or null. */
        public getParentOther(api: API, callback: IAPICallback<Other>) {
         ...
         *  @return A single Other, or null. */
        public static getParentOtherForOther(otherID: number, api: API, callback: IAPICallback<Other>) {
    ...
    export class OtherRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<OtherRelation>>, page?: number) {
            api.executeEndpoint<Array<OtherRelation>>(Endpoint.fromSelf<Array<OtherRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<OtherRelation>) {
            api.executeEndpoint<OtherRelation>(Endpoint.fromSelf<OtherRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<OtherRelation>>, page?: number) {
            api.executeEndpoint<Array<OtherRelation>>(Endpoint.fromSelf<Array<OtherRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorOtherID(otherID: number, api: API, callback: IAPICallback<Array<OtherRelation>>, page?: number) {
            api.executeEndpoint<Array<OtherRelation>>(Endpoint.fromSelf<Array<OtherRelation>>(), callback, { otherID: otherID }, null, page);
        }

        /** Gets how many OtherRelations by AncestorOtherID exist. 
         *  @param otherID The ID of the Other for which to retrieve the child OtherRelations.
         *  @return An Array of OtherRelations. */
        public static getByAncestorOtherIDCount(otherID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { otherID: otherID });
        }
         ...
         *  @param otherID The ID of the Other for which to retrieve the child OtherRelations.
         *  @return An Array of OtherRelations. */
        public static getByAncestorOtherIDPageCount(otherID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { otherID: otherID });
        }
         ...
         *  @param otherID The ID of the Other for which to retrieve the child OtherRelations.
         *  @return An Array of OtherRelations. */
        public static getByDescendantOtherID(otherID: number, api: API, callback: IAPICallback<Array<OtherRelation>>, page?: number) {
            api.executeEndpoint<Array<OtherRelation>>(Endpoint.fromSelf<Array<OtherRelation>>(), callback, { otherID: otherID }, null, page);
        }
         ...
         *  @param otherID The ID of the Other for which to retrieve the child OtherRelations.
         *  @return An Array of OtherRelations. */
        public static getByDescendantOtherIDCount(otherID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { otherID: otherID });
        }
         ...
         *  @param otherID The ID of the Other for which to retrieve the child OtherRelations.
         *  @return An Array of OtherRelations. */
        public static getByDescendantOtherIDPageCount(otherID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { otherID: otherID });
        }
    ...
    export class RaceEthnicity extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<RaceEthnicity>>, page?: number) {
            api.executeEndpoint<Array<RaceEthnicity>>(Endpoint.fromSelf<Array<RaceEthnicity>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<RaceEthnicity>) {
            api.executeEndpoint<RaceEthnicity>(Endpoint.fromSelf<RaceEthnicity>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<RaceEthnicity>>, page?: number) {
            api.executeEndpoint<Array<RaceEthnicity>>(Endpoint.fromSelf<Array<RaceEthnicity>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getRaceEthnicities(api: API, callback: IAPICallback<Array<RaceEthnicity>>, page?: number) {
         ...
         *  @return An Array of RaceEthnicities. */
        public static getByParentRaceEthnicityID(raceEthnicityID: number, api: API, callback: IAPICallback<Array<RaceEthnicity>>, page?: number) {
            api.executeEndpoint<Array<RaceEthnicity>>(Endpoint.fromSelf<Array<RaceEthnicity>>(), callback, { raceEthnicityID: raceEthnicityID }, null, page);
        }

        /** Gets how many RaceEthnicities by ParentRaceEthnicityID exist. 
         *  @return An Array of RaceEthnicities. */
        public getRaceEthnicitiesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child RaceEthnicities.
         *  @return An Array of RaceEthnicities. */
        public static getByParentRaceEthnicityIDCount(raceEthnicityID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { raceEthnicityID: raceEthnicityID });
        }

        /** Gets how many pages of RaceEthnicities by ParentRaceEthnicityID exist.
         *  @return An Array of RaceEthnicities. */
        public getRaceEthnicitiesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child RaceEthnicities.
         *  @return An Array of RaceEthnicities. */
        public static getByParentRaceEthnicityIDPageCount(raceEthnicityID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { raceEthnicityID: raceEthnicityID });
        }
        ...
        public getParentRaceEthnicity(api: API, callback: IAPICallback<RaceEthnicity>) {
         ...
         *  @return A single RaceEthnicity, or null. */
        public static getParentRaceEthnicityForRaceEthnicity(raceEthnicityID: number, api: API, callback: IAPICallback<RaceEthnicity>) {
    ...
    export class RaceEthnicityRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<RaceEthnicityRelation>>, page?: number) {
            api.executeEndpoint<Array<RaceEthnicityRelation>>(Endpoint.fromSelf<Array<RaceEthnicityRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<RaceEthnicityRelation>) {
            api.executeEndpoint<RaceEthnicityRelation>(Endpoint.fromSelf<RaceEthnicityRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<RaceEthnicityRelation>>, page?: number) {
            api.executeEndpoint<Array<RaceEthnicityRelation>>(Endpoint.fromSelf<Array<RaceEthnicityRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorRaceEthnicityID(raceEthnicityID: number, api: API, callback: IAPICallback<Array<RaceEthnicityRelation>>, page?: number) {
            api.executeEndpoint<Array<RaceEthnicityRelation>>(Endpoint.fromSelf<Array<RaceEthnicityRelation>>(), callback, { raceEthnicityID: raceEthnicityID }, null, page);
        }

        /** Gets how many RaceEthnicityRelations by AncestorRaceEthnicityID exist. 
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child RaceEthnicityRelations.
         *  @return An Array of RaceEthnicityRelations. */
        public static getByAncestorRaceEthnicityIDCount(raceEthnicityID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { raceEthnicityID: raceEthnicityID });
        }
         ...
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child RaceEthnicityRelations.
         *  @return An Array of RaceEthnicityRelations. */
        public static getByAncestorRaceEthnicityIDPageCount(raceEthnicityID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { raceEthnicityID: raceEthnicityID });
        }
         ...
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child RaceEthnicityRelations.
         *  @return An Array of RaceEthnicityRelations. */
        public static getByDescendantRaceEthnicityID(raceEthnicityID: number, api: API, callback: IAPICallback<Array<RaceEthnicityRelation>>, page?: number) {
            api.executeEndpoint<Array<RaceEthnicityRelation>>(Endpoint.fromSelf<Array<RaceEthnicityRelation>>(), callback, { raceEthnicityID: raceEthnicityID }, null, page);
        }
         ...
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child RaceEthnicityRelations.
         *  @return An Array of RaceEthnicityRelations. */
        public static getByDescendantRaceEthnicityIDCount(raceEthnicityID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { raceEthnicityID: raceEthnicityID });
        }
         ...
         *  @param raceEthnicityID The ID of the RaceEthnicity for which to retrieve the child RaceEthnicityRelations.
         *  @return An Array of RaceEthnicityRelations. */
        public static getByDescendantRaceEthnicityIDPageCount(raceEthnicityID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { raceEthnicityID: raceEthnicityID });
        }
    ...
    export class Sex extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Sex>>, page?: number) {
            api.executeEndpoint<Array<Sex>>(Endpoint.fromSelf<Array<Sex>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Sex>) {
            api.executeEndpoint<Sex>(Endpoint.fromSelf<Sex>(), callback, { id: id });
        }

        /** Returns a filtered collection of Sexes based on the provided filter.
         *  @param filter The Filter to apply.
         *  @return All Sexes which match the provided filter. */
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Sex>>, page?: number) {
            api.executeEndpoint<Array<Sex>>(Endpoint.fromSelf<Array<Sex>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getSexes(api: API, callback: IAPICallback<Array<Sex>>, page?: number) {
         ...
         *  @return An Array of Sexes. */
        public static getByParentSexID(sexID: number, api: API, callback: IAPICallback<Array<Sex>>, page?: number) {
            api.executeEndpoint<Array<Sex>>(Endpoint.fromSelf<Array<Sex>>(), callback, { sexID: sexID }, null, page);
        }

        /** Gets how many Sexes by ParentSexID exist. 
         *  @return An Array of Sexes. */
        public getSexesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param sexID The ID of the Sex for which to retrieve the child Sexes.
         *  @return An Array of Sexes. */
        public static getByParentSexIDCount(sexID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexID: sexID });
        }

        /** Gets how many pages of Sexes by ParentSexID exist.
         *  @return An Array of Sexes. */
        public getSexesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param sexID The ID of the Sex for which to retrieve the child Sexes.
         *  @return An Array of Sexes. */
        public static getByParentSexIDPageCount(sexID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexID: sexID });
        }

        /** Returns the related ParentSex based on the unique ID of the related Sex.
         *  @return A single Sex, or null. */
        public getParentSex(api: API, callback: IAPICallback<Sex>) {
         ...
         *  @return A single Sex, or null. */
        public static getParentSexForSex(sexID: number, api: API, callback: IAPICallback<Sex>) {
    ...
    export class SexRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<SexRelation>>, page?: number) {
            api.executeEndpoint<Array<SexRelation>>(Endpoint.fromSelf<Array<SexRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<SexRelation>) {
            api.executeEndpoint<SexRelation>(Endpoint.fromSelf<SexRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<SexRelation>>, page?: number) {
            api.executeEndpoint<Array<SexRelation>>(Endpoint.fromSelf<Array<SexRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorSexID(sexID: number, api: API, callback: IAPICallback<Array<SexRelation>>, page?: number) {
            api.executeEndpoint<Array<SexRelation>>(Endpoint.fromSelf<Array<SexRelation>>(), callback, { sexID: sexID }, null, page);
        }

        /** Gets how many SexRelations by AncestorSexID exist. 
         *  @param sexID The ID of the Sex for which to retrieve the child SexRelations.
         *  @return An Array of SexRelations. */
        public static getByAncestorSexIDCount(sexID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexID: sexID });
        }
         ...
         *  @param sexID The ID of the Sex for which to retrieve the child SexRelations.
         *  @return An Array of SexRelations. */
        public static getByAncestorSexIDPageCount(sexID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexID: sexID });
        }
         ...
         *  @param sexID The ID of the Sex for which to retrieve the child SexRelations.
         *  @return An Array of SexRelations. */
        public static getByDescendantSexID(sexID: number, api: API, callback: IAPICallback<Array<SexRelation>>, page?: number) {
            api.executeEndpoint<Array<SexRelation>>(Endpoint.fromSelf<Array<SexRelation>>(), callback, { sexID: sexID }, null, page);
        }
         ...
         *  @param sexID The ID of the Sex for which to retrieve the child SexRelations.
         *  @return An Array of SexRelations. */
        public static getByDescendantSexIDCount(sexID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexID: sexID });
        }
         ...
         *  @param sexID The ID of the Sex for which to retrieve the child SexRelations.
         *  @return An Array of SexRelations. */
        public static getByDescendantSexIDPageCount(sexID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexID: sexID });
        }
    ...
    export class SexualOrientation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<SexualOrientation>>, page?: number) {
            api.executeEndpoint<Array<SexualOrientation>>(Endpoint.fromSelf<Array<SexualOrientation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<SexualOrientation>) {
            api.executeEndpoint<SexualOrientation>(Endpoint.fromSelf<SexualOrientation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<SexualOrientation>>, page?: number) {
            api.executeEndpoint<Array<SexualOrientation>>(Endpoint.fromSelf<Array<SexualOrientation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getSexualOrientations(api: API, callback: IAPICallback<Array<SexualOrientation>>, page?: number) {
         ...
         *  @return An Array of SexualOrientations. */
        public static getByParentSexualOrientationID(sexualOrientationID: number, api: API, callback: IAPICallback<Array<SexualOrientation>>, page?: number) {
            api.executeEndpoint<Array<SexualOrientation>>(Endpoint.fromSelf<Array<SexualOrientation>>(), callback, { sexualOrientationID: sexualOrientationID }, null, page);
        }

        /** Gets how many SexualOrientations by ParentSexualOrientationID exist. 
         *  @return An Array of SexualOrientations. */
        public getSexualOrientationsCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child SexualOrientations.
         *  @return An Array of SexualOrientations. */
        public static getByParentSexualOrientationIDCount(sexualOrientationID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexualOrientationID: sexualOrientationID });
        }

        /** Gets how many pages of SexualOrientations by ParentSexualOrientationID exist.
         *  @return An Array of SexualOrientations. */
        public getSexualOrientationsPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child SexualOrientations.
         *  @return An Array of SexualOrientations. */
        public static getByParentSexualOrientationIDPageCount(sexualOrientationID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexualOrientationID: sexualOrientationID });
        }
        ...
        public getParentSexualOrientation(api: API, callback: IAPICallback<SexualOrientation>) {
         ...
         *  @return A single SexualOrientation, or null. */
        public static getParentSexualOrientationForSexualOrientation(sexualOrientationID: number, api: API, callback: IAPICallback<SexualOrientation>) {
    ...
    export class SexualOrientationRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<SexualOrientationRelation>>, page?: number) {
            api.executeEndpoint<Array<SexualOrientationRelation>>(Endpoint.fromSelf<Array<SexualOrientationRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<SexualOrientationRelation>) {
            api.executeEndpoint<SexualOrientationRelation>(Endpoint.fromSelf<SexualOrientationRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<SexualOrientationRelation>>, page?: number) {
            api.executeEndpoint<Array<SexualOrientationRelation>>(Endpoint.fromSelf<Array<SexualOrientationRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorSexualOrientationID(sexualOrientationID: number, api: API, callback: IAPICallback<Array<SexualOrientationRelation>>, page?: number) {
            api.executeEndpoint<Array<SexualOrientationRelation>>(Endpoint.fromSelf<Array<SexualOrientationRelation>>(), callback, { sexualOrientationID: sexualOrientationID }, null, page);
        }

        /** Gets how many SexualOrientationRelations by AncestorSexualOrientationID exist. 
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child SexualOrientationRelations.
         *  @return An Array of SexualOrientationRelations. */
        public static getByAncestorSexualOrientationIDCount(sexualOrientationID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexualOrientationID: sexualOrientationID });
        }
         ...
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child SexualOrientationRelations.
         *  @return An Array of SexualOrientationRelations. */
        public static getByAncestorSexualOrientationIDPageCount(sexualOrientationID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexualOrientationID: sexualOrientationID });
        }
         ...
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child SexualOrientationRelations.
         *  @return An Array of SexualOrientationRelations. */
        public static getByDescendantSexualOrientationID(sexualOrientationID: number, api: API, callback: IAPICallback<Array<SexualOrientationRelation>>, page?: number) {
            api.executeEndpoint<Array<SexualOrientationRelation>>(Endpoint.fromSelf<Array<SexualOrientationRelation>>(), callback, { sexualOrientationID: sexualOrientationID }, null, page);
        }
         ...
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child SexualOrientationRelations.
         *  @return An Array of SexualOrientationRelations. */
        public static getByDescendantSexualOrientationIDCount(sexualOrientationID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexualOrientationID: sexualOrientationID });
        }
         ...
         *  @param sexualOrientationID The ID of the SexualOrientation for which to retrieve the child SexualOrientationRelations.
         *  @return An Array of SexualOrientationRelations. */
        public static getByDescendantSexualOrientationIDPageCount(sexualOrientationID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { sexualOrientationID: sexualOrientationID });
        }
    ...
    export class Timeframe extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Timeframe>>, page?: number) {
            api.executeEndpoint<Array<Timeframe>>(Endpoint.fromSelf<Array<Timeframe>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Timeframe>) {
            api.executeEndpoint<Timeframe>(Endpoint.fromSelf<Timeframe>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Timeframe>>, page?: number) {
            api.executeEndpoint<Array<Timeframe>>(Endpoint.fromSelf<Array<Timeframe>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class Total extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Total>>, page?: number) {
            api.executeEndpoint<Array<Total>>(Endpoint.fromSelf<Array<Total>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Total>) {
            api.executeEndpoint<Total>(Endpoint.fromSelf<Total>(), callback, { id: id });
        }

        /** Returns a filtered collection of Totals based on the provided filter.
         *  @param filter The Filter to apply.
         *  @return All Totals which match the provided filter. */
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Total>>, page?: number) {
            api.executeEndpoint<Array<Total>>(Endpoint.fromSelf<Array<Total>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getTotals(api: API, callback: IAPICallback<Array<Total>>, page?: number) {
         ...
         *  @return An Array of Totals. */
        public static getByParentTotalID(totalID: number, api: API, callback: IAPICallback<Array<Total>>, page?: number) {
            api.executeEndpoint<Array<Total>>(Endpoint.fromSelf<Array<Total>>(), callback, { totalID: totalID }, null, page);
        }

        /** Gets how many Totals by ParentTotalID exist. 
         *  @return An Array of Totals. */
        public getTotalsCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param totalID The ID of the Total for which to retrieve the child Totals.
         *  @return An Array of Totals. */
        public static getByParentTotalIDCount(totalID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { totalID: totalID });
        }

        /** Gets how many pages of Totals by ParentTotalID exist.
         *  @return An Array of Totals. */
        public getTotalsPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param totalID The ID of the Total for which to retrieve the child Totals.
         *  @return An Array of Totals. */
        public static getByParentTotalIDPageCount(totalID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { totalID: totalID });
        }

        /** Returns the related ParentTotal based on the unique ID of the related Total.
         *  @return A single Total, or null. */
        public getParentTotal(api: API, callback: IAPICallback<Total>) {
         ...
         *  @return A single Total, or null. */
        public static getParentTotalForTotal(totalID: number, api: API, callback: IAPICallback<Total>) {
    ...
    export class TotalRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<TotalRelation>>, page?: number) {
            api.executeEndpoint<Array<TotalRelation>>(Endpoint.fromSelf<Array<TotalRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<TotalRelation>) {
            api.executeEndpoint<TotalRelation>(Endpoint.fromSelf<TotalRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<TotalRelation>>, page?: number) {
            api.executeEndpoint<Array<TotalRelation>>(Endpoint.fromSelf<Array<TotalRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorTotalID(totalID: number, api: API, callback: IAPICallback<Array<TotalRelation>>, page?: number) {
            api.executeEndpoint<Array<TotalRelation>>(Endpoint.fromSelf<Array<TotalRelation>>(), callback, { totalID: totalID }, null, page);
        }

        /** Gets how many TotalRelations by AncestorTotalID exist. 
         *  @param totalID The ID of the Total for which to retrieve the child TotalRelations.
         *  @return An Array of TotalRelations. */
        public static getByAncestorTotalIDCount(totalID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { totalID: totalID });
        }
         ...
         *  @param totalID The ID of the Total for which to retrieve the child TotalRelations.
         *  @return An Array of TotalRelations. */
        public static getByAncestorTotalIDPageCount(totalID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { totalID: totalID });
        }
         ...
         *  @param totalID The ID of the Total for which to retrieve the child TotalRelations.
         *  @return An Array of TotalRelations. */
        public static getByDescendantTotalID(totalID: number, api: API, callback: IAPICallback<Array<TotalRelation>>, page?: number) {
            api.executeEndpoint<Array<TotalRelation>>(Endpoint.fromSelf<Array<TotalRelation>>(), callback, { totalID: totalID }, null, page);
        }
         ...
         *  @param totalID The ID of the Total for which to retrieve the child TotalRelations.
         *  @return An Array of TotalRelations. */
        public static getByDescendantTotalIDCount(totalID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { totalID: totalID });
        }
         ...
         *  @param totalID The ID of the Total for which to retrieve the child TotalRelations.
         *  @return An Array of TotalRelations. */
        public static getByDescendantTotalIDPageCount(totalID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { totalID: totalID });
        }
    ...
    export class Url extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Url>>, page?: number) {
            api.executeEndpoint<Array<Url>>(Endpoint.fromSelf<Array<Url>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Url>) {
            api.executeEndpoint<Url>(Endpoint.fromSelf<Url>(), callback, { id: id });
        }

        /** Returns a filtered collection of Urls based on the provided filter.
         *  @param filter The Filter to apply.
         *  @return All Urls which match the provided filter. */
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Url>>, page?: number) {
            api.executeEndpoint<Array<Url>>(Endpoint.fromSelf<Array<Url>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class ValueLabel extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<ValueLabel>>, page?: number) {
            api.executeEndpoint<Array<ValueLabel>>(Endpoint.fromSelf<Array<ValueLabel>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<ValueLabel>) {
            api.executeEndpoint<ValueLabel>(Endpoint.fromSelf<ValueLabel>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<ValueLabel>>, page?: number) {
            api.executeEndpoint<Array<ValueLabel>>(Endpoint.fromSelf<Array<ValueLabel>>(), callback, null, filter.toJSON(page));
        }
    ...
    export class VeteranStatus extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<VeteranStatus>>, page?: number) {
            api.executeEndpoint<Array<VeteranStatus>>(Endpoint.fromSelf<Array<VeteranStatus>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<VeteranStatus>) {
            api.executeEndpoint<VeteranStatus>(Endpoint.fromSelf<VeteranStatus>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<VeteranStatus>>, page?: number) {
            api.executeEndpoint<Array<VeteranStatus>>(Endpoint.fromSelf<Array<VeteranStatus>>(), callback, null, filter.toJSON(page));
        }
        ...
        public getVeteranStatuses(api: API, callback: IAPICallback<Array<VeteranStatus>>, page?: number) {
         ...
         *  @return An Array of VeteranStatuses. */
        public static getByParentVeteranStatusID(veteranStatusID: number, api: API, callback: IAPICallback<Array<VeteranStatus>>, page?: number) {
            api.executeEndpoint<Array<VeteranStatus>>(Endpoint.fromSelf<Array<VeteranStatus>>(), callback, { veteranStatusID: veteranStatusID }, null, page);
        }

        /** Gets how many VeteranStatuses by ParentVeteranStatusID exist. 
         *  @return An Array of VeteranStatuses. */
        public getVeteranStatusesCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child VeteranStatuses.
         *  @return An Array of VeteranStatuses. */
        public static getByParentVeteranStatusIDCount(veteranStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { veteranStatusID: veteranStatusID });
        }

        /** Gets how many pages of VeteranStatuses by ParentVeteranStatusID exist.
         *  @return An Array of VeteranStatuses. */
        public getVeteranStatusesPageCount(api: API, callback: IAPICallback<number>) {
         ...
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child VeteranStatuses.
         *  @return An Array of VeteranStatuses. */
        public static getByParentVeteranStatusIDPageCount(veteranStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { veteranStatusID: veteranStatusID });
        }
        ...
        public getParentVeteranStatus(api: API, callback: IAPICallback<VeteranStatus>) {
         ...
         *  @return A single VeteranStatus, or null. */
        public static getParentVeteranStatusForVeteranStatus(veteranStatusID: number, api: API, callback: IAPICallback<VeteranStatus>) {
    ...
    export class VeteranStatusRelation extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<VeteranStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<VeteranStatusRelation>>(Endpoint.fromSelf<Array<VeteranStatusRelation>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<VeteranStatusRelation>) {
            api.executeEndpoint<VeteranStatusRelation>(Endpoint.fromSelf<VeteranStatusRelation>(), callback, { id: id });
        }
        ...
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<VeteranStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<VeteranStatusRelation>>(Endpoint.fromSelf<Array<VeteranStatusRelation>>(), callback, null, filter.toJSON(page));
        }
        ...
        public static getByAncestorVeteranStatusID(veteranStatusID: number, api: API, callback: IAPICallback<Array<VeteranStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<VeteranStatusRelation>>(Endpoint.fromSelf<Array<VeteranStatusRelation>>(), callback, { veteranStatusID: veteranStatusID }, null, page);
        }

        /** Gets how many VeteranStatusRelations by AncestorVeteranStatusID exist. 
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child VeteranStatusRelations.
         *  @return An Array of VeteranStatusRelations. */
        public static getByAncestorVeteranStatusIDCount(veteranStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { veteranStatusID: veteranStatusID });
        }
         ...
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child VeteranStatusRelations.
         *  @return An Array of VeteranStatusRelations. */
        public static getByAncestorVeteranStatusIDPageCount(veteranStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { veteranStatusID: veteranStatusID });
        }
         ...
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child VeteranStatusRelations.
         *  @return An Array of VeteranStatusRelations. */
        public static getByDescendantVeteranStatusID(veteranStatusID: number, api: API, callback: IAPICallback<Array<VeteranStatusRelation>>, page?: number) {
            api.executeEndpoint<Array<VeteranStatusRelation>>(Endpoint.fromSelf<Array<VeteranStatusRelation>>(), callback, { veteranStatusID: veteranStatusID }, null, page);
        }
         ...
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child VeteranStatusRelations.
         *  @return An Array of VeteranStatusRelations. */
        public static getByDescendantVeteranStatusIDCount(veteranStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { veteranStatusID: veteranStatusID });
        }
         ...
         *  @param veteranStatusID The ID of the VeteranStatus for which to retrieve the child VeteranStatusRelations.
         *  @return An Array of VeteranStatusRelations. */
        public static getByDescendantVeteranStatusIDPageCount(veteranStatusID: number, api: API, callback: IAPICallback<number>) {
            api.executeEndpoint<number>(Endpoint.fromSelf<number>(), callback, { veteranStatusID: veteranStatusID });
        }
    ...
    export class Year extends ServiceDataObject {
        ...
        public static getAll(api: API, callback: IAPICallback<Array<Year>>, page?: number) {
            api.executeEndpoint<Array<Year>>(Endpoint.fromSelf<Array<Year>>(), callback, null, null, page);
        }
        ...
        public static getByID(id: number, api: API, callback: IAPICallback<Year>) {
            api.executeEndpoint<Year>(Endpoint.fromSelf<Year>(), callback, { id: id });
        }

        /** Returns a filtered collection of Years based on the provided filter.
         *  @param filter The Filter to apply.
         *  @return All Years which match the provided filter. */
        public static filter(filter: Filter, api: API, callback: IAPICallback<Array<Year>>, page?: number) {
            api.executeEndpoint<Array<Year>>(Endpoint.fromSelf<Array<Year>>(), callback, null, filter.toJSON(page));
        }
